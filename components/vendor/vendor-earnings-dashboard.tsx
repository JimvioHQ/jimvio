    ...
    return (
      <div className="space-y-6 max-w-[1100px] mx-auto">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-32 rounded-2xl bg-[var(--color-surface-secondary)] animate-pulse" />
          ))}
        </div>
        <div className="h-64 rounded-2xl bg-[var(--color-surface-secondary)] animate-pulse" />
      </div>
    );
  }
