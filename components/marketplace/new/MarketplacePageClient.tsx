...
// function CategoryImage({ name, imageUrl }: { name: string; imageUrl: string | null }) {
...
//       ) : (
//         <span
//           className="text-2xl leading-none transition-transform group-hover:scale-110 select-none"
//           role="img"
//           aria-label={name}
//         >
//           {emoji}
...
//       <div className="flex items-center gap-3 rounded-md border border-border bg-card px-4 py-1 shadow-sm">
...
//                     className="group flex items-center justify-between gap-2 overflow-hidden rounded-xl border border-border p-2.5 text-left transition-transform hover:-translate-y-0.5"
...
//                     <CategoryImage name={c.name} imageUrl={c.image_url} />
//                   </a>
//                 ))}
//               </div>
//             </section>
              ...
              <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7">
                {categories.map((c) => (
                  <a
                    key={c.id}
                    href={`/marketplace?category=${c.slug}`}
                    className="group relative flex flex-col justify-end overflow-hidden rounded-xl p-3 text-left transition-all hover:-translate-y-0.5 hover:shadow-md"
                    style={{
                      height: 110,
                      background: c.tint_color ?? "var(--color-surface-secondary)",
                      border: "1px solid var(--color-border)",
                    }}
                  >
                    {/* Big image top-right */}
                    <div className="absolute right-0 top-0 h-full w-3/5 flex items-center justify-end pr-1 pt-1">
                      <CategoryImage name={c.name} imageUrl={c.image_url} size="lg" />
                    </div>
