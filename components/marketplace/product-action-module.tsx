...
// import {
//   ShoppingCart, Loader2, CheckCircle2, Heart, MessageSquare, Zap, Gift,
// } from "lucide-react";
...
//             ? `/order-confirmation?order_id=${result.orderId}`
...
import React, { useState, useEffect } from "react";
import {
  ShoppingCart, Loader2, CheckCircle2, Heart, MessageSquare, Zap, Gift, FolderOpen,
} from "lucide-react";
import { toast } from "sonner";
import { Button } from "@/components/ui/button";
import {
...
export function ProductActionModule({
  ...
  useEffect(() => {
    ...
    const checks: [Promise<string[]>, Promise<boolean>] = [
      getWishlistProductIds(),
      isFreeDigital
        ? checkUserOwnsProduct(product.id)
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Already owned — show access link instead */}
