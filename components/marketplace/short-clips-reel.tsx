  ...
  return (
    <section className={cn("space-y-6", className)}>
      ...
      <div className="flex items-end justify-between px-2">
        <div className="space-y-1.5">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-none bg-orange-50 dark:bg-orange-500/10 text-[10px] font-black uppercase tracking-[0.14em] text-orange-600 border border-orange-100/50 dark:border-orange-500/20 shadow-none">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-none bg-orange-500 opacity-60" />
              <span className="relative inline-flex rounded-none h-2 w-2 bg-orange-600" />
            </span>
            Live Feed
          </div>
        ...
        <Link
          href="/shorts"
          className="group flex items-center gap-2.5 px-6 py-3.5 rounded-none bg-stone-950 dark:bg-surface border border-white/5 text-white text-[12px] font-black uppercase tracking-[0.15em] transition-all active:scale-[0.97] shadow-none hover:bg-black dark:hover:bg-bg"
        >
          Watch All
          <div className="h-4 w-4 rounded-none bg-orange-500 flex items-center justify-center p-0.5 group-hover:scale-110 transition-transform">
          ...
          >
            ...
            >
              ...
              <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
                 <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-none bg-black/40 border border-white/15 shadow-none">
                    <span className="h-1.5 w-1.5 rounded-none bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)]" />
                    <span className="text-[8px] font-black text-white uppercase tracking-[0.1em]">Live Now</span>
                 </div>
                 {video.video_type !== "general" && (
                    <div className={cn(
                      "flex items-center gap-1.5 px-3 py-1.5 rounded-none border border-white/10 text-[8px] font-black uppercase tracking-[0.12em] text-white shadow-none",
              ...
              <div className="absolute inset-x-0 bottom-0 p-3 pt-4 space-y-1">
                <div className="flex items-center gap-1.5">
                  <div className="h-5 w-5 rounded-none border-2 border-white/40 overflow-hidden bg-white dark:bg-surface/20 shadow-none transition-transform group-hover:scale-110">
                  ...
                  <span className="text-[10px] font-bold text-white tracking-tight drop-shadow-none truncate">
                    {video.creator.name}
                  </span>
                </div>
                
                <h3 className="text-[12px] font-black text-white leading-[1.1] line-clamp-1 drop-shadow-none tracking-tight">
                   {video.title}
                </h3>

                <div className="flex items-center gap-2.5">
                  <div className="flex items-center gap-1 text-white/90 text-[9px] font-black drop-shadow-none">
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
                <div className="h-16 w-16 rounded-none bg-white dark:bg-surface/20 border border-white/30 flex items-center justify-center scale-75 group-hover:scale-100 transition-all duration-500 shadow-none">
                  <Play className="h-7 w-7 text-white fill-white ml-1 shadow-none" />
                </div>
              </div>
            </Link>
              ...
              {video.video_type === "product" && video.product ? (
                <div className="space-y-2">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {video.product.price != null && (
                      <div className="shrink-0 px-2.5 py-1 rounded-none bg-orange-500/10 dark:bg-orange-500/20 border border-orange-500/20 dark:border-orange-500/30">
                  ...
                  <Link 
                    ...
                    className="flex items-center justify-center gap-2 w-full h-10 rounded-none bg-orange-600 hover:bg-orange-700 text-white text-[11px] font-black uppercase tracking-widest transition-all transform active:scale-[0.96] shadow-none shadow-orange-600/10"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <a 
                    ...
                    target="_blank"
                    className="flex items-center justify-center gap-2 w-full h-10 rounded-none bg-orange-600 hover:bg-orange-700 text-white text-[11px] font-black uppercase tracking-widest transition-all active:scale-[0.96] shadow-none shadow-orange-600/10"
                  >
