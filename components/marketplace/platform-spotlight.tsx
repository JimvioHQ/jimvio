...
//       {/* FEATURED CAMPAIGN */}
//       <div className="relative group overflow-hidden rounded-sm bg-slate-950 p-8 min-h-[300px] flex flex-col justify-between border border-white/10 shadow-none">
...
//             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-orange-500/10 border border-orange-500/20 text-orange-500 text-[10px] font-black uppercase tracking-widest">
...
//             <Button asChild variant="orange" size="lg" className="rounded-sm font-black px-8 uppercase tracking-widest transition-all">
...
//       {/* FEATURED COMMUNITY */}
//       <div className="relative group overflow-hidden rounded-sm bg-indigo-600 p-8 min-h-[300px] flex flex-col justify-between border border-white/10 shadow-none">
...
//          <div className="relative z-10 space-y-4">
//             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-white dark:bg-surface/10 border border-white/20 text-white text-[10px] font-black uppercase tracking-widest">
...
//          <div className="relative z-10 pt-6">
//             <Button asChild size="lg" className="rounded-sm bg-white dark:bg-surface text-indigo-600 hover:bg-zinc-100 font-black px-8">
