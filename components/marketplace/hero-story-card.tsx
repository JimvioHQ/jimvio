  ...
  return (
    <>
      <div 
        ...
        className="relative aspect-[9/16] rounded-sm overflow-hidden shadow-none group-hover/clip:scale-[1.02] transition-transform duration-700 cursor-pointer ring-8 ring-white dark:ring-surface shadow-orange-500/10 active:scale-[0.98]"
      >
        <div 
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-16 h-16 rounded-sm bg-white dark:bg-surface/20 border border-white/30 flex items-center justify-center text-white scale-90 group-hover/clip:scale-100 transition-transform">
        ...
        <div className="absolute bottom-6 left-6 right-6 text-white text-left">
          ...
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-sm bg-[#f97316] flex items-center justify-center text-[10px] font-black border border-white/20">
