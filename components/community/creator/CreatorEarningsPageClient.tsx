    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        {[
          ...
          <div key={c.label} className="rounded-sm border border-[var(--color-border)] bg-[var(--color-surface)] p-4 shadow-none">
      ...
      <section className="rounded-sm border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:p-6">
        ...
        <div className="h-72 w-full">
          {chartData.every((d) => d.monthly + d.yearly + d.lifetime === 0) ? (
            <div className="h-full flex items-center justify-center rounded-sm border border-dashed border-[var(--color-border)] text-sm text-[var(--color-text-muted)]">
      ...
      <section className="rounded-sm border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden">
                  ...
                  return (
                    <tr key={p.id} className="border-b border-[var(--color-border)]">
                      ...
                      <td className="py-2 px-3">
                        <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded-sm bg-[var(--color-surface-secondary)]">{p.plan_type}</span>
                      </td>
      ...
      <section className="rounded-sm border border-[var(--color-border)] bg-[var(--color-surface)] p-4 sm:p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-xl">
          <div>
            ...
            <Input value={amount} onChange={(e) => setAmount(e.target.value)} type="number" min={MIN_PAYOUT} step="0.01" className="rounded-sm mt-1" />
          </div>
          <div>
            ...
            <select
              ...
              className="mt-1 w-full rounded-sm border border-[var(--color-border)] px-3 py-2 text-sm bg-[var(--color-surface)]"
            >
          ...
          <div className="sm:col-span-2">
            ...
            <Input value={account} onChange={(e) => setAccount(e.target.value)} className="rounded-sm mt-1" placeholder="Phone, IBAN, or wallet address" />
          </div>
        </div>
        ...
        <Button
          type="button"
          className={cn("rounded-sm bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] text-white font-black")}
          disabled={submitting}
