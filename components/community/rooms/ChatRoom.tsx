...
//       {!own && (
//         <div className="h-8 w-8 rounded-sm shrink-0 mr-2 mt-1 animate-pulse"
//           style={{ background: "#d1d7db" }} />
//       )}
//       <div className="rounded-sm px-3 py-2.5 animate-pulse"
//         style={{
...
//         }}>
//         <div className="h-3 rounded-sm mb-2" style={{ background: "#d1d7db", width: "70%" }} />
//         <div className="h-3 rounded-sm mb-2" style={{ background: "#d1d7db", width: wide ? "90%" : "50%" }} />
//         {wide && <div className="h-3 rounded-sm mb-2" style={{ background: "#d1d7db", width: "40%" }} />}
//         <div className="flex justify-end mt-2">
//           <div className="h-2 w-8 rounded-sm" style={{ background: "#d1d7db" }} />
//         </div>
//       </div>
//     </div>
//   );
...
//         className="flex h-10 w-10 shrink-0 items-center justify-center rounded-sm text-white shadow-none"
//         style={{ background: WA.accent }}>
//         {playing ? <Pause className="h-5 w-5" /> : <Play className="h-5 w-5 ml-0.5" />}
//       </button>
//       <div className="flex flex-col flex-1 min-w-0 gap-1.5">
//         {/* Progress bar */}
//         <div className="relative h-1.5 rounded-sm overflow-hidden cursor-pointer"
...
//         className="h-9 w-9 flex items-center justify-center rounded-sm text-white shadow transition-colors disabled:opacity-50"
//         style={{ background: WA.accent }}>
...
//       className={cn("flex h-9 w-9 shrink-0 items-center justify-center rounded-sm transition-colors disabled:opacity-40",
...
//   return (
//     <div className="mb-1.5 rounded-sm overflow-hidden flex"
...
//         <p className="text-[12px] truncate leading-snug" style={{ color: WA.textSecondary }}>{body || "📎 Attachment"}</p>
//       </div>
//     </div>
//   );
// }
...
//         {/* Avatar */}
//         {!isOwn && !compact && (
//           <div className="h-8 w-8 rounded-sm overflow-hidden shrink-0 mt-1"
...
//           {/* Bubble */}
//           <div className="relative rounded-sm px-2.5 pt-1.5 pb-2 shadow-none"
//             style={{
...
//                         <a key={a.url} href={a.url} target="_blank" rel="noopener noreferrer" className="block rounded-sm overflow-hidden max-w-full">
...
//             <button type="button"
//               className="inline-flex items-center gap-1 rounded-sm px-2 py-1 text-xs font-medium hover:bg-black/5 transition-colors"
//               style={{ color: WA.textSecondary }}
//               onClick={() => onReply(m)}>
...
//                 <button type="button" className="h-7 w-7 inline-flex items-center justify-center rounded-sm hover:bg-black/5 transition-colors" style={{ color: WA.textSecondary }}>
...
//             </div>
//             <div className="w-full h-72 bg-[#233138] rounded-sm overflow-hidden relative shadow-none border border-white/10">
//               {remoteStream && <video autoPlay playsInline ref={remoteVideoRef} className="w-full h-full object-cover" />}
//               {localStream && <video autoPlay playsInline muted ref={localVideoRef} className={cn("absolute bottom-3 right-3 w-24 h-36 bg-black rounded-sm border border-white/20 object-cover shadow-none", !remoteStream && "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-56")} />}
//               {!remoteStream && !localStream && <div className="absolute inset-0 flex flex-col items-center justify-center gap-3"><div className="w-14 h-14 rounded-sm flex items-center justify-center animate-pulse" style={{ background: WA.accent }}>{callType === 'video' ? <Video className="h-7 w-7" /> : <Phone className="h-7 w-7" />}</div><p className="text-sm text-white/70">Connecting...</p></div>}
//             </div>
//             <div className="mt-4">
//               <button onClick={handleEndCall} className="w-16 h-16 rounded-sm bg-red-500 flex items-center justify-center hover:bg-red-600 active:scale-90 shadow-none transition-all"><Phone className="h-8 w-8 rotate-[135deg]" /></button>
//             </div>
//           </div>
//         </div>
//       )}
...
//           <Textarea value={editBody} onChange={e => setEditBody(e.target.value)} rows={4} className="mt-2 rounded-sm" />
//           <div className="mt-4 flex justify-end gap-2">
//             <Button variant="outline" className="rounded-sm" onClick={() => setEditingMsg(null)}>Cancel</Button>
//             <Button className="rounded-sm font-semibold text-white" style={{ background: WA.accent }} disabled={editSaving || !editBody.trim()} onClick={() => void saveEdit()}>
...
//           <button className="h-8 w-8 flex items-center justify-center rounded-sm" style={{ color: WA.textSecondary }}><MoreHorizontal size={18} /></button>
//         </div>
...
//                 onClick={() => { setActiveConvId(null); setActiveConvPeer(null); setForceShowList(false); router.push(`/c/${slug}/workspace?space=${r.spaceId}&room=${r.id}`); }}>
...
//             <button type="button" className="flex h-10 w-10 items-center justify-center rounded-sm bg-white dark:bg-surface/80 shadow-none" style={{ color: WA.accent }} onClick={() => setForceShowList(true)}>
//               <ChevronLeft size={24} />
//             </button>
//           </div>
//         )}
...
//             <button onClick={() => startNativeCall('audio')} className="flex h-10 w-10 items-center justify-center rounded-sm bg-white dark:bg-surface/90 shadow-none border border-gray-200 hover:scale-105 transition-all"><Phone className="h-4 w-4" style={{ color: WA.accent }} /></button>
//             <button onClick={() => startNativeCall('video')} className="flex h-10 w-10 items-center justify-center rounded-sm bg-white dark:bg-surface/90 shadow-none border border-gray-200 hover:scale-105 transition-all"><Video className="h-4 w-4" style={{ color: WA.accent }} /></button>
//           </div>
//         )}
...
//                 className="w-full rounded-sm border-0 py-2 pl-10 pr-4 text-sm outline-none" style={{ background: WA.searchBg, color: WA.text }} />
//             </div>
...
//               <button type="button" onClick={() => scrollToBottom()} className="pointer-events-auto h-10 w-10 flex items-center justify-center rounded-sm shadow-none" style={{ background: WA.header, color: WA.accent, border: `1px solid ${WA.border}` }}>
...
//                   {[...Array(22)].map((_, i) => (
//                     <div key={i} className="shrink-0 w-[3px] rounded-sm"
//                       style={{
//                         background: "#f15c6d",
...
//                 className="flex h-10 w-10 shrink-0 items-center justify-center rounded-sm text-white shadow"
...
//                 <label htmlFor="wa-img-input" className="cursor-pointer flex h-9 w-9 items-center justify-center rounded-sm hover:bg-black/5">
...
//                 <label htmlFor="wa-file-input" className="cursor-pointer flex h-9 w-9 items-center justify-center rounded-sm hover:bg-black/5">
...
//                   <div className="flex flex-wrap gap-1.5 px-1 py-1.5 mb-1 rounded-sm" style={{ background: "rgba(0,0,0,0.04)" }}>
//                     {pendingMain.map((a, i) => (
//                       <div key={a.url} className="flex items-center gap-1.5 px-2 py-1 bg-white dark:bg-surface rounded-sm shadow-none text-[11px] font-medium" style={{ border: `1px solid ${WA.border}` }}>
...
//             </div>
//             <button type="button" className="h-8 w-8 flex items-center justify-center rounded-sm" style={{ color: WA.textSecondary }} onClick={() => setThreadOpen(false)}><X className="h-5 w-5" /></button>
//           </div>
...
//                   <span key={`${a.url}-${i}`} className="inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-1 rounded-sm" style={{ background: WA.datePill, color: WA.text, border: `1px solid ${WA.border}` }}>
...
//               <div className="flex-1 rounded-sm px-4 py-2" style={{ background: WA.panel, border: `1px solid ${WA.border}` }}>
...
//               </div>
//               <button type="button" className="h-10 w-10 shrink-0 flex items-center justify-center rounded-sm text-white disabled:opacity-50" style={{ background: WA.accent }}
...
//               <button onClick={() => setIncomingCall(null)} className="w-14 h-14 rounded-sm bg-red-500 flex items-center justify-center hover:bg-red-600 active:scale-90 shadow-none transition-all"><X className="h-6 w-6" /></button>
//               <button onClick={() => { setCallType(incomingCall.type); setIncomingCall(null); iceQueueRef.current = []; initWebRTC(incomingCall.type, false); }}
//                 className="w-16 h-16 rounded-sm flex items-center justify-center active:scale-95 shadow-none animate-bounce" style={{ background: WA.accent }}>
...
export function ChatRoom({
  ...
  // ─── Render ────────────────────────────────────────────────────────────────
  return (
    <div className="flex flex-1 h-full min-h-screen max-h-screen font-sans overflow-y-hidden ">
