...
export function HubCommunityChatShell() {
  ...
  return (
    <div className="grid min-h-[calc(100vh-120px)] gap-4 lg:grid-cols-[1fr_280px]">
      <div className="flex min-h-0 flex-col overflow-hidden rounded-md border border-[var(--color-border)] bg-[var(--color-surface)]">
