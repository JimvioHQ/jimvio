  ...
  return (
    <div className="flex flex-1 flex-col min-h-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-8">
        ...
        <div className="rounded-sm border border-[var(--color-border)] overflow-hidden bg-[var(--color-surface)]">
...
function Podium({
  ...
  return (
    <div className={cn("flex flex-col items-center text-center", large && "order-2 sm:order-none")}>
      <div
        className={cn(
          "relative rounded-sm border border-[var(--color-border)] bg-[var(--color-surface)] p-3 shadow-none flex flex-col items-center",
          h,
