        ...
        >
          ...
          {mobileBottomLinks.map(link => {
            ...
            return (
              ...
              >
                <link.icon className={cn("h-6 w-6 transition-transform duration-500", active ? "scale-110 drop-shadow-[0_0_8px_rgba(249,115,22,0.4)]" : "scale-100")} />
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={cn("transition-all duration-500 relative z-10", active ? "text-white drop-shadow-md scale-110" : "text-zinc-500 dark:text-white/40 group-hover:text-zinc-900 dark:group-hover:text-white")}>
          {icon}
        </div>
      </div>
