...
//   [key: string]: any;
// }>((
//   { children, href, onClick, className, active = false, orange = false, style, ...props },
//   ref
// ) => {
//   const cls = cn(
...
// /* --- Trending search suggestions (customize as needed) --- */
// const TRENDING_SEARCHES = [
//   { label: "Wireless chargers", count: "142 products", emoji: "🔋" },
//   { label: "Wireless earbuds", count: "89 products", emoji: "🎧" },
//   { label: "Laptop accessories", count: "230 products", emoji: "💻" },
//   { label: "LED desk lamps", count: "77 products", emoji: "💡" },
//   { label: "Phone stands", count: "190 products", emoji: "📱" },
// ];
...
//   const [searchOpen, setSearchOpen] = useState(false); // ← NEW: mobile search overlay
...
//                       <Link
//                         href={s.href}
//                         className="relative flex items-center gap-3 p-3 rounded-sm group/item transition-all hover:bg-stone-50 dark:hover:bg-white/5"
//                         style={{ outline: "none" }}
//                       >
//                         <div
//                           className="h-9 w-9 rounded-sm flex items-center justify-center shrink-0 bg-stone-50 dark:bg-stone-900 border border-stone-100 dark:border-stone-800"
//                           style={{ color: s.color }}
//                         >
...
//                     <DropdownMenuItem key={v.href} asChild className="p-0 focus:bg-transparent rounded-sm">
//                       <Link
//                         href={v.href}
//                         className="relative flex items-center gap-3 p-3 rounded-sm group/item transition-all hover:bg-stone-50 dark:hover:bg-white/5"
//                         style={{ outline: "none" }}
...
//                   <DropdownMenuContent
//                     align="end"
//                     className="w-60 p-1.5 mt-2 rounded-sm border border-border bg-surface shadow-none outline-none"
//                   >
//                     <div className="px-3 py-3 rounded-sm mb-1.5 bg-stone-50 dark:bg-stone-900 border border-border">
...
//             {/* ── MOBILE: Search icon (standalone, no drawer) ── */}
//             <ConsoleIconBtn
//               className="md:hidden"
...
//                 className="fixed top-0 inset-x-0 z-[9991] md:hidden bg-white dark:bg-[#0a0a0a] border-b border-stone-100 dark:border-white/8 shadow-2xl"
//               >
//                 {/* Input row */}
//                 <div className="flex items-center gap-3 px-4 pt-4 pb-3">
//                   <div className="flex-1 flex items-center gap-2.5 bg-stone-50 dark:bg-[#111] border border-[#fd5000]/50 focus-within:border-[#fd5000] rounded-full px-4 h-10 transition-colors">
...
//                       <button
//                         onClick={() => setSearchQ("")}
//                         className="flex items-center justify-center h-5 w-5 rounded-full bg-stone-200 dark:bg-stone-700 shrink-0 transition-colors hover:bg-stone-300"
//                       >
//                         <X className="h-3 w-3 text-stone-500 dark:text-stone-400" />
//                       </button>
//                     )}
//                   </div>
//                   <button
//                     onClick={() => { setSearchOpen(false); setSearchQ(""); }}
//                     className="text-[13px] font-semibold text-[#fd5000] shrink-0 px-1 py-1 transition-opacity hover:opacity-70"
//                   >
//                     Cancel
//                   </button>
//                 </div>
...
//                   {!searchQ.trim() ? (
//                     /* ── Trending (no query yet) ── */
//                     <>
//                       <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest px-1 pb-2 pt-1">
//                         Trending
//                       </p>
...
//                           >
//                             <div className="h-9 w-9 rounded-xl bg-orange-50 dark:bg-orange-500/10 flex items-center justify-center text-[18px] shrink-0">
//                               {item.emoji}
//                             </div>
...
//                         <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest px-1 pb-2">
//                           Browse
//                         </p>
...
//                                 </div>
//                                 <span className="text-[13px] font-semibold text-stone-800 dark:text-white">{l.label}</span>
//                                 <ChevronRight className="h-4 w-4 text-stone-300 dark:text-stone-600 ml-auto shrink-0 group-hover:text-[#fd5000] transition-colors" />
//                               </Link>
//                             );
//                           })}
//                       </div>
...
//                         </div>
//                         <span className="text-[13px] font-bold text-[#fd5000] text-left">
//                           Search all results for &ldquo;{searchQ}&rdquo;
//                         </span>
//                         <ChevronRight className="h-4 w-4 text-[#fd5000] ml-auto shrink-0" />
//                       </button>
//                     </>
//                   )}
//                 </div>
...
//   open, onClose, user, pathname, marketing, navLinks, solutions, marketplaceVariants, scrolled, openAssistant,
// }: any) {
...
//                         className={cn(
//                           "w-full flex items-center justify-between p-3 rounded-xl text-[14px] font-semibold transition-all",
//                           expanded === 'account'
//                             ? "bg-white dark:bg-[#1a1a1a] text-stone-900 dark:text-white shadow-sm"
//                             : "text-stone-700 dark:text-stone-300 hover:bg-white dark:hover:bg-[#1a1a1a]"
//                         )}
//                       >
...
//                                 href={link.href}
//                                 onClick={onClose}
//                                 className="flex items-center gap-3 p-2.5 rounded-lg text-[13px] font-medium text-stone-600 hover:bg-white dark:text-stone-400 dark:hover:bg-[#1a1a1a] transition-colors"
//                               >
...
//                       <Link href="/login" onClick={onClose} className="flex items-center justify-center p-3 rounded-xl bg-white dark:bg-[#1a1a1a] text-[12px] font-semibold text-stone-700 dark:text-stone-300 shadow-sm active:scale-95 transition-all border border-stone-100 dark:border-white/5">
//                         Log In
//                       </Link>
//                       <Link href="/register" onClick={onClose} className="flex items-center justify-center p-3 rounded-xl bg-[#fd5000] hover:bg-[#e04700] text-[12px] font-semibold text-white shadow-[0_2px_8px_rgba(253,80,0,0.25)] active:scale-95 transition-all">
//                         Join Free
//                       </Link>
//                     </div>
//                   )}
...
//                   onClick={onClose}
//                   className={cn(
//                     "flex items-center gap-4 p-4 rounded-xl text-[15px] font-semibold transition-all",
//                     pathname === "/"
//                       ? "bg-orange-50 dark:bg-orange-500/10 text-[#fd5000] border border-orange-100 dark:border-orange-500/20"
//                       : "text-stone-700 dark:text-stone-300 hover:bg-stone-50 dark:hover:bg-[#111]"
//                   )}
//                 >
//                   <Home className={cn("h-5 w-5", pathname === "/" ? "text-[#fd5000]" : "text-stone-400")} />
//                   Home
//                 </Link>
...
//                     className={cn(
//                       "w-full flex items-center justify-between p-4 rounded-xl text-[15px] font-semibold transition-all",
//                       expanded === 'market'
//                         ? "bg-stone-50 dark:bg-[#111] text-stone-900 dark:text-white"
//                         : "text-stone-700 dark:text-stone-300 hover:bg-stone-50 dark:hover:bg-[#111]"
//                     )}
//                   >
...
//                             className="flex items-center gap-4 p-3 rounded-lg text-[13px] font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-50 dark:hover:bg-[#111] hover:text-[#fd5000] transition-colors">
...
//                   )}
//                 >
//                   <Users className={cn("h-5 w-5", pathname.startsWith("/communities") ? "text-[#fd5000]" : "text-stone-400")} />
//                   Communities
//                 </Link>
...
//                   )}
//                 >
//                   <CircleHelp className={cn("h-5 w-5", pathname.startsWith("/help") ? "text-[#fd5000]" : "text-stone-400")} />
//                   Help Center
//                 </Link>
//               </div>
          ...
          <div className="flex-1 flex items-center justify-end gap-1.5 min-w-0">
            ...
            <div className="hidden sm:flex items-center shrink-0">
              {user ? (
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <Link href="/login" className="h-9 px-4 flex items-center text-[12px] font-bold text-stone-600 dark:text-stone-300 border border-border bg-white dark:bg-stone-900 hover:bg-stone-50 dark:hover:bg-stone-800 hover:text-stone-900 dark:hover:text-white transition-all whitespace-nowrap">
                    Log In
                  </Link>
                  <Link href="/register" className="h-9 px-4 flex items-center text-[12px] font-black uppercase tracking-widest bg-orange-500 text-white hover:bg-orange-600 transition-all active:scale-95 shrink-0 whitespace-nowrap">
                    Join Free
                  </Link>
                </div>
              )}
