  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      >
        {isLoggedIn ? (
          <>
            <h4 className="text-[13px] font-black text-zinc-900 dark:text-white mb-0.5 leading-tight">Welcome back</h4>
            ...
            <div className="flex items-center gap-2.5 mb-3 p-2.5 bg-zinc-50/80 rounded-xl border border-zinc-100 dark:border-border">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[12px] font-black text-zinc-900 dark:text-white truncate">
          ...
          <>
            <h4 className="text-[13px] font-black text-zinc-900 dark:text-white mb-0.5 leading-tight">Professional B2B Sourcing</h4>
