...
export function HeroRightPanel({ profile }: HeroRightPanelProps) {
  ...
  return (
    ...
    >
      {/* ── Main card ── */}
      <div
        className="bg-white dark:bg-surface rounded-sm border border-black/[.07] dark:border-white/[.08] p-[14px] flex flex-col gap-0"
      >
        {isLoggedIn ? (
          <>
            ...
            <div className="flex items-center gap-[10px] mb-3 p-[10px_12px] bg-[#f8f7f4] dark:bg-white/[.04] rounded-sm border border-black/[.05] dark:border-white/[.06]">
            ...
            <Link
              href="/dashboard"
              className="flex items-center justify-center gap-[6px] w-full h-[36px] rounded-sm mb-[10px] text-[10px] font-black uppercase tracking-[.08em] text-[#c2410c] dark:text-[#fb923c] transition-all"
              style={{
            ...
            <div className="grid grid-cols-2 gap-2 mb-2">
              <Link
                ...
                className="flex items-center justify-center gap-[5px] h-[30px] rounded-sm text-[10px] font-bold text-[#6b6257] dark:text-[#a89f93] transition-all hover:bg-[#f5f4f1]"
            ...
            <form action={signOut}>
              <button
                type="submit"
                className="flex items-center justify-center gap-[5px] w-full h-[30px] rounded-sm text-[10px] font-semibold text-[#a89f93] transition-all hover:bg-[#f5f4f1]"
          ...
          <>
            ...
            <Link
              href="/login"
              className="flex items-center justify-center w-full h-[36px] rounded-sm mb-[10px] text-[10px] font-black uppercase tracking-[.08em] text-[#c2410c] dark:text-[#fb923c] transition-all"
              style={{
                background: "rgba(249,115,22,.10)",
                border: "0.5px solid rgba(249,115,22,.25)",
              }}
            ...
            <div className="grid grid-cols-2 gap-[6px]">
              ...
              <Link
                href="/login"
                className="flex items-center justify-center gap-[6px] h-[30px] rounded-sm text-[10px] font-bold text-[#6b6257] dark:text-[#a89f93] hover:bg-[#f5f4f1] dark:hover:bg-white/[.04] transition-all"
                style={{ border: "0.5px solid rgba(0,0,0,.07)" }}
              >
      ...
      <div className="grid grid-cols-2 gap-2">
        <Link
          ...
          className="group flex flex-col items-center gap-[6px] bg-white dark:bg-surface rounded-sm py-[10px] px-3 text-center cursor-pointer transition-all hover:border-[rgba(249,115,22,.3)]"
          style={{ border: "0.5px solid rgba(0,0,0,.07)" }}
        >
      ...
      <Link
        href="/affiliates"
        className="group relative overflow-hidden rounded-sm p-3 cursor-pointer hover:brightness-105 transition-all"
        style={{
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div
            className="w-9 h-9 rounded-sm flex items-center justify-center text-[16px] font-bold text-white shrink-0 group-hover:scale-110 transition-transform"
            style={{
          ...
          <div
            className="shrink-0 rounded-sm px-[10px] py-[4px] text-[11px] font-black text-white"
            style={{
