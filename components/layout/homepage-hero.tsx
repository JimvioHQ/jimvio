...
export function HomepageHero({
  ...
  return (
    <>
      ...
      <section className="hidden lg:flex flex-col items-center justify-center w-full min-h-[580px] lg:min-h-[650px] relative overflow-hidden bg-white border-b border-zinc-100">
        <div className="absolute inset-0 z-0">
          <GlobeCanvas />
        </div>
        ...
        <div className="absolute inset-0 z-0 select-none pointer-events-none">
          <Image
            ...
            fill
            className="object-cover opacity-[0.25] saturate-[1.25] scale-105"
            priority
          />
