...
//             ])
//             const { data, count, error } = Products;
//             console.log("Affiliate products data:", { data, count, error });
//             if (error) {
...
//                 slug: p.slug,
//                 title: p.name,
//                 campaign_type: p.product_categories?.name ?? p.product_type ?? "Affiliate",
...
//                 totalProducts: spotlight.length,
//             });

//             if (displayCampaigns.length > 0) {
//                 setCards(displayCampaigns);
//             }
//         }
...
//                             </h2>
//                             <p className="text-base max-w-lg" style={{ color: "var(--color-text-muted)" }}>
//                                 Get your unique affiliate link. Share anywhere. Earn up to {heroRate}% on every
//                                 purchase your referral makes — automatically.
//                             </p>
//                         </div>
