          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-zinc-100 dark:border-border">
              <div className="flex items-center gap-2">
                ...
                <span className="bg-zinc-100 text-zinc-500 text-[10px] font-black px-2 py-0.5 rounded-sm">
                  {cartCount}
                </span>
              </div>
              <button 
                onClick={onClose}
                className="h-8 w-8 rounded-sm hover:bg-zinc-100 flex items-center justify-center transition-colors"
              >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              {isLoading && orders.length === 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center">
                  <div className="h-16 w-16 bg-zinc-50 dark:bg-surface/50 rounded-sm flex items-center justify-center mb-4">
                  ...
                  <Button 
                    variant="outline"
                    onClick={onClose}
                    className="mt-6 rounded-sm font-black text-[11px] uppercase tracking-wider"
                  >
                    Start Shopping
                  </Button>
                </div>
                      ...
                      <div className="space-y-4">
                        {order.order_items.map((item: any) => (
                          <div key={item.id} className="flex gap-4 group">
                            <div className="relative h-16 w-16 shrink-0 bg-zinc-50 dark:bg-surface/50 rounded-sm border border-zinc-100 dark:border-border overflow-hidden">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center justify-between mt-2">
                                <div className="flex items-center gap-2">
                                  <div className="flex items-center h-6 border border-zinc-100 dark:border-border rounded-sm overflow-hidden bg-zinc-50/50">
                                    <button 
            ...
            {orders.length > 0 && (
              <div className="p-6 bg-zinc-50/50 border-t border-zinc-100 dark:border-border space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3 pt-2">
                  <Button 
                    asChild
                    className="w-full h-12 bg-zinc-900 hover:bg-black text-white rounded-sm font-black text-sm shadow-none shadow-zinc-900/20"
                  >
