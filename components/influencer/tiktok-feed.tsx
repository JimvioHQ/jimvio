  ...
  if (!clips.length) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] bg-[#FAF8F5]">
        <div className="w-20 h-20 rounded-3xl bg-white dark:bg-surface border-2 border-[#E8E3D8] flex items-center justify-center mb-5 shadow-sm">
        ...
        <div className="lg:hidden absolute bottom-0 left-0 right-16 z-20 p-5 pb-8">
          ...
          <div className="mb-2">
            ...
            {(clip.video_type === "general" || !clip.video_type) && clip.external_link && (
              <span className="inline-block px-2.5 py-1 text-[10px] font-black text-[#1C1A17] bg-white dark:bg-surface/90 rounded-lg shadow-sm">Sponsored</span>
            )}
          </div>
          ...
          {(!clip.video_type || clip.video_type === "product") && clip.products && (
            <div className="space-y-2.5 max-w-[290px]">
              <button
                ...
                className="flex items-center gap-3 w-full px-3.5 py-3 rounded-2xl bg-white dark:bg-surface shadow-lg shadow-black/15 border border-[#E8E3D8] hover:bg-[#FAF8F5] transition-colors text-left"
              >
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="w-11 h-11 rounded-xl bg-white dark:bg-surface border border-[#E8E3D8] text-[#1C1A17] flex items-center justify-center transition-all shadow-md disabled:opacity-50 active:scale-[0.98]"
          ...
          {(clip.video_type === "general" || (!clip.video_type && !!clip.external_link)) && clip.external_link && (
            <button
              ...
              className="flex items-center justify-center gap-2 h-11 px-5 rounded-xl bg-white dark:bg-surface border border-[#E8E3D8] text-[#1C1A17] text-[13px] font-black shadow-md transition-colors active:scale-[0.98]"
            >
            ...
            <div className="px-7 py-7 border-b border-[#F3F0EA]">
              ...
              <div className="w-full rounded-[20px] overflow-hidden bg-[#FAF8F5] border border-[#E8E3D8] shadow-sm mb-5">
                <button type="button" onClick={() => setProductPopup(clip)} className="flex items-center gap-4 w-full p-4 text-left group">
                  <div className="w-18 h-18 rounded-2xl bg-white dark:bg-surface flex items-center justify-center shrink-0 overflow-hidden border border-[#E8E3D8] shadow-sm" style={{ width: 72, height: 72 }}>
                    {Array.isArray(clip.products.images) && clip.products.images[0]
              ...
              <div className="flex gap-3">
                ...
                <button
                  disabled={addingToCart[clip.id] || addedItems[clip.id]}
                  className="w-12 h-12 rounded-xl bg-white dark:bg-surface border border-[#E8E3D8] hover:bg-[#F3F0EA] text-[#1C1A17] flex items-center justify-center transition-all disabled:opacity-50 active:scale-95 shadow-sm"
                  onClick={(e) => { e.stopPropagation(); handleAddToCart(clip); }}
                >
              ...
              <div className="w-full rounded-[20px] overflow-hidden bg-[#FAF8F5] border border-[#E8E3D8] shadow-sm mb-5 group/comm">
                <div className="h-24 bg-gradient-to-br from-[#D85A30]/10 to-indigo-100/50 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-4 flex items-center gap-2.5">
                    <div className="w-10 h-10 rounded-xl bg-white dark:bg-surface shadow-lg border border-[#E8E3D8] flex items-center justify-center">
                      ...
                      <div className="space-y-2.5 mb-4">
                        {[{ icon: <Sparkles className="h-3 w-3" />, text: "Premium Networking" }, { icon: <Play className="h-3 w-3" />, text: "Exclusive Content" }, { icon: <CheckCircle2 className="h-3 w-3" />, text: "Verified Community" }].map((feat, i) => (
                          <div key={i} className="flex items-center gap-2.5 text-[13px] font-medium text-[#5C574F]">
                            <div className="w-6 h-6 rounded-lg bg-white dark:bg-surface border border-[#E8E3D8] flex items-center justify-center text-[#D85A30]">{feat.icon}</div>
                            {feat.text}
                          </div>
                        ))}
                      </div>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[300] flex items-end lg:items-stretch lg:justify-end">
          ...
          <motion.div
            ...
            className="relative w-full h-[72vh] bg-white dark:bg-surface rounded-t-[28px] flex flex-col overflow-hidden lg:h-full lg:w-96 lg:translate-x-0 lg:rounded-none border-t border-[#E8E3D8] shadow-[0_-8px_40px_rgba(0,0,0,0.1)]"
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4 bg-[#FAF8F5]">
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center h-40 text-center gap-3">
                  <div className="w-14 h-14 rounded-2xl bg-white dark:bg-surface border border-[#E8E3D8] flex items-center justify-center shadow-sm">
                ...
                <div key={comment.id} className="flex gap-3 p-3.5 bg-white dark:bg-surface rounded-2xl border border-[#F3F0EA] shadow-sm">
