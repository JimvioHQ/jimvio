    ...
    return (
        <div className="w-full max-w-sm space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                {error && (
                    <div role="alert" className="rounded-sm bg-red-50 p-3 text-center text-sm font-semibold text-red-600">
                        {error}
                    </div>
                )}
                ...
                <Button
                    type="submit"
                    className="w-full h-12 rounded-sm bg-zinc-900 font-bold text-white"
                    disabled={pending}
                >
            ...
            <p className="text-center text-xs text-zinc-500">
                ...
                <span className="font-semibold">Use a backup code above.</span>
            </p>
        </div>
    );
}