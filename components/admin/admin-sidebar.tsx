...
//           />
//           {collapsed && (
//             <div className="h-8 w-8 rounded-sm bg-red-600 flex items-center justify-center">
...
//             className="p-1.5 rounded-sm text-[var(--color-text-muted)] hover:bg-[var(--color-surface-secondary)] shrink-0 hidden lg:inline-flex"
...
//               className="lg:hidden flex h-10 w-10 items-center justify-center rounded-sm text-[var(--color-text-primary)] bg-[var(--color-surface-secondary)] border border-[var(--color-border)]/80 active:scale-[0.97] transition-transform"
...
//                   onClick={onMobileClose}
//                   className={cn(
//                     "flex items-center gap-2.5 px-2.5 py-2 rounded-sm text-sm font-medium transition-all",
...
//               "rounded-sm-3xl overflow-hidden animate-in slide-in-from-left duration-200"
//             )}
//           >
//             {content}
//           </aside>
