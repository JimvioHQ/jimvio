...
//             className={cn(
//                "relative w-full text-left transition-all duration-200 active:scale-[0.985] rounded-sm overflow-hidden ",
//                active 
...
//               <div
//                 className={cn(
//                    "flex-shrink-0 flex items-center justify-center rounded-sm w-9 h-9 border",
//                    active 
...
//               <div
//                 className={cn(
//                    "flex-shrink-0 flex items-center justify-center rounded-sm transition-all duration-200 w-[21px] h-[21px] border-2",
//                    active 
...
/* ── Inline brand pills — zero CDN, theme-safe ───────────────────────────── */
