        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full h-11 px-4 rounded-sm border border-[var(--color-border)] bg-[var(--color-surface)] text-sm mt-1"
            >
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button type="submit" className="rounded-sm flex-1 bg-[var(--color-accent)]" disabled={loading}>
