...
export function QuoteReplyModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-ink-darker/50" onClick={onClose}>
      <div className="bg-[var(--color-surface)] rounded-sm shadow-none max-w-md w-full p-6" onClick={(e) => e.stopPropagation()}>
        ...
        {quoteData && (
          <div className="mb-4 p-3 rounded-sm bg-[var(--color-surface-secondary)] text-sm text-[var(--color-text-secondary)]">
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-4 py-2 rounded-sm border border-[var(--color-border)] bg-[var(--color-surface)] text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] mt-1 resize-none"
            />
          </div>
          <div className="flex gap-2 pt-2">
            <Button type="button" variant="outline" className="rounded-sm flex-1" onClick={onClose}>
              Cancel
            </Button>
            <Button
              type="button"
              variant="outline"
              className="rounded-sm flex-1 border-red-200 text-red-600 hover:bg-red-50"
            ...
            <Button
              type="button"
              className="rounded-sm flex-1 bg-[var(--color-accent)]"
