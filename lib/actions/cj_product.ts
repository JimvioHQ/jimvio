...
//         if (images.length >= MAX_REMARK_IMAGES) break;
...
//     const compare_at_price = Math.ceil((retailUsd * 1.2 * exchangeRate) / 100) * 100;
...
//     const { price, compare_at_price } = calculateRetailPrice(costUsd, exchangeRate);
//     const categoryId = await findOrCreateCategory(supabase, cjProduct.categoryName);
...
//     console.debug("Mapping CJ variant", { cjVariant });
//     return {
...
//         // Top-level CJ columns (migration 061)
...
//         },
//         options: {
//             variant_key: cjVariant.variantProperty || cjVariant.variantSku,
//         },
//     };
// }
...
//         // Throttle to avoid hammering Supabase on large batches
