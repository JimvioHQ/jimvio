      ...
      <div className="relative hidden w-0 flex-1 lg:block bg-zinc-950 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-16 xl:px-24 z-10">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-10 max-w-lg">
            <div>
              <p className="text-3xl xl:text-4xl font-primary font-black text-white mb-1.5">500k+</p>
              <p className="text-[12px] font-bold text-stone-400 uppercase tracking-widest">Active Products</p>
              <div className="h-0.5 w-8 bg-orange-500/50 mt-4 rounded-sm" />
            </div>
            <div>
              <p className="text-3xl xl:text-4xl font-black font-primary text-white mb-1.5">$2M+</p>
              <p className="text-[12px] font-bold text-stone-400 uppercase tracking-widest">Commissions Paid</p>
          ...
          <div className="absolute bottom-12 left-16 xl:left-24 text-[12px] font-medium text-zinc-600">
            &copy; {new Date().getFullYear()} Jimvio Inc.
          </div>
        </div>
      </div>
    </div>
