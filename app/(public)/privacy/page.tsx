...
import { PrivacyPage } from "@/components/landing-page";
...
export default function PrivacyPolicyPage() {
  ...
  //       <div className="bg-white dark:bg-surface border border-[var(--color-border)] rounded-sm p-8 md:p-16 shadow-none relative overflow-hidden">
  //          <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-50 rounded-sm-[4rem]" />

  //          <div className="space-y-16">
  //             {sections.map((s, i) => (
  //               <section key={i} className="space-y-6">
  //                  <div className="flex items-center gap-4">
  //                     <div className="h-10 w-10 rounded-sm bg-emerald-100 text-emerald-600 flex items-center justify-center">
  //                        {s.icon}
  //                     </div>
  ...
  //                        <div className="mt-1.5 w-1.5 h-1.5 rounded-sm bg-emerald-500 shrink-0" />
  ...
  //             <div className="p-8 bg-emerald-50 rounded-sm border border-emerald-100 flex items-start gap-4">
