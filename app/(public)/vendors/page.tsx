...
export default async function VendorsPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      {/* Hero Header */}
      <section className="bg-white dark:bg-surface border-b border-[var(--color-border)] py-16">
      ...
      <section className="py-20 max-w-[var(--container-max)] mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-white dark:bg-surface border border-[var(--color-border)] rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="py-10 max-w-[var(--container-max)] mx-auto px-4 sm:px-6 mb-20">
        <div className="flex items-center justify-between mb-10">
          ...
          <select className="bg-white dark:bg-surface border border-[var(--color-border)] rounded-lg px-4 py-2 text-sm font-bold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {vendors.map((vendor: any) => (
            <div key={vendor.id} className="bg-white dark:bg-surface border border-[var(--color-border)] rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
