  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] pt-[var(--navbar-height)] pb-10">
      <div className="max-w-[var(--container-max)] mx-auto px-4 sm:px-6 h-[calc(100vh-var(--navbar-height)-3rem)]">
        <div className="bg-white dark:bg-surface border border-[var(--color-border)] rounded-none shadow-none h-full flex overflow-hidden">
            ...
            <div className="p-6 border-b border-[var(--color-border)]">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-4 bg-[var(--color-surface-secondary)] border border-[var(--color-border)] rounded-none text-sm outline-none focus:ring-2 focus:ring-[var(--color-accent)]/20 transition-all"
                />
              </div>
            </div>
              ...
              {!user ? (
                <div className="text-center py-12 px-6">
                  ...
                  <Link href={`/login?returnUrl=${encodeURIComponent("/messages")}`}>
                    <Button className="bg-[var(--color-accent)] text-white font-black rounded-none gap-2">
                ...
                <div className="text-center py-12 px-6">
                  ...
                  <Link href="/marketplace">
                    <Button className="bg-[var(--color-accent)] text-white font-black rounded-none">
                      Browse marketplace
                    </Button>
                  </Link>
                </div>
          ...
          <div className="flex-1 flex flex-col bg-[var(--color-surface-secondary)] min-w-0 hidden md:flex">
            <div className="flex-1 flex flex-col items-center justify-center text-center p-12">
              <div className="h-24 w-24 bg-white dark:bg-surface rounded-none shadow-none border border-[var(--color-border)] flex items-center justify-center mb-8">
              ...
              <Link href="/marketplace">
                <Button variant="outline" className="font-black h-12 px-8 rounded-none border-2">
                  Go to marketplace
                </Button>
              </Link>
            </div>
