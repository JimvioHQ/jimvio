  ...
  return (
    <div className="bg-[var(--color-bg)] min-h-screen">
      ...
      <section className="bg-ink-dark text-white py-16 relative overflow-hidden">
        ...
        <div className="absolute -left-24 -top-24 w-96 h-96 bg-[var(--color-accent)] opacity-20 blur-[120px] rounded-sm" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="max-w-2xl">
              ...
              <div className="flex items-center gap-6">
                ...
                <Button className="bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] font-black h-14 px-8 rounded-sm shadow-none shadow-[var(--color-accent)]/20">
                  Shop All Deals
                </Button>
              </div>
            </div>
            ...
            <div className="hidden lg:block relative">
               <div className="h-64 w-64 bg-[var(--color-accent)] rounded-sm rotate-12 flex items-center justify-center relative shadow-none">
                 <Percent className="h-32 w-32 text-white opacity-20 -rotate-12" />
                 <div className="absolute -bottom-4 -left-4 bg-white dark:bg-surface text-text-primary px-6 py-4 rounded-sm shadow-none font-black text-2xl animate-bounce">
                   UP TO 70% OFF
                 </div>
               </div>
            </div>
      ...
      <section className="py-12 max-w-[var(--container-max)] mx-auto px-4 sm:px-6">
        ...
        {dealProducts.length === 0 && (
          <div className="py-32 text-center bg-white dark:bg-surface border border-dashed border-[var(--color-border)] rounded-sm">
      ...
      <section className="py-20 max-w-[var(--container-max)] mx-auto px-4 sm:px-6 mb-20">
        <div className="bg-gradient-to-br from-ink-dark to-ink-darker rounded-sm p-12 flex flex-col md:flex-row items-center gap-10 border border-white/5 relative overflow-hidden">
          ...
          <div className="flex-1 text-center md:text-left relative z-10">
            ...
            <Button className="bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] font-black text-lg h-14 px-10 rounded-sm">
              Talk to an Agent <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </div>
          <div className="relative z-10">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white dark:bg-surface/5 backdrop-blur-md p-6 rounded-sm border border-white/10 text-center">
