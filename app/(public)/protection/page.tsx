    ...
    <div className="bg-[var(--color-bg)] min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex-1 hidden md:block">
            <div className="relative">
              ...
              <div className="relative bg-white dark:bg-zinc-900 border border-[var(--color-border)] rounded-[3rem] p-10 shadow-2xl">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1 order-2 md:order-1">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-[var(--color-border)] shadow-sm">
              ...
              <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-[var(--color-border)] shadow-sm mt-8">
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto bg-blue-600 rounded-[3rem] p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-blue-600/30">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white dark:bg-zinc-900 opacity-10 blur-[100px]" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="xl" className="bg-white dark:bg-zinc-900 text-blue-600 hover:bg-white dark:bg-zinc-900/90 font-black rounded-xl h-16 px-10">
              Create Secure Account
            </Button>
            <Button size="xl" variant="outline" className="text-white border-white/20 hover:bg-white dark:bg-zinc-900/5 font-black rounded-xl h-16 px-10">
               Contact Support
            </Button>
          </div>
        </div>
