        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            {[
              ...
              <div key={i} className="bg-white dark:bg-surface border border-[var(--color-border)] p-8 rounded-sm shadow-none flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-16">
          ...
          <div className="flex gap-4 w-full md:w-auto">
            <div className="relative flex-1 md:w-64">
              ...
              <input placeholder="Search factories..." className="w-full h-11 pl-10 pr-4 bg-white dark:bg-surface border border-[var(--color-border)] rounded-sm text-sm" />
            </div>
            <Button className="bg-[var(--color-accent)] font-black rounded-sm h-11 px-6">Filter</Button>
          </div>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {vendors.map((vendor: any) => (
            <div key={vendor.id} className="bg-white dark:bg-surface border border-[var(--color-border)] rounded-sm p-8 shadow-none hover:shadow-none hover:-translate-y-1 transition-all duration-300">
               <div className="flex items-start gap-6">
                 <div className="h-28 w-28 rounded-sm bg-[var(--color-accent-light)] border border-[var(--color-accent-subtle)] flex items-center justify-center text-[var(--color-accent)] font-black text-4xl overflow-hidden shrink-0">
                 ...
                 <div className="flex-1">
                   ...
                   <div className="flex gap-4">
                     <Button className="flex-1 bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] font-black h-12 rounded-sm">
                       Inquire Now
                     </Button>
                     <Button variant="outline" className="flex-1 font-black h-12 rounded-sm border-2" asChild>
