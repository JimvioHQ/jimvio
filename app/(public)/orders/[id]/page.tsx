...
//   MessageSquare, Star, RotateCcw, X, Store,
...
// /* ─── Reusable button styles (design-system aligned) ────────────── */

// // Premium pill CTA: h-11, radius-full, semibold, scale on press
// const btnPrimary = cn(
...
// // Secondary outline button: h-9, radius-sm, medium
...
//         <div
//           className="h-4 w-28 animate-pulse bg-[var(--color-surface-secondary)]"
//           style={{ borderRadius: "var(--radius-sm)" }}
//         />
//         <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
//           <div className="space-y-3 lg:col-span-2">
//             <div
//               className="h-48 animate-pulse bg-[var(--color-surface-secondary)]"
//               style={{ borderRadius: "var(--radius-lg)" }}
//             />
//             <div
//               className="h-40 animate-pulse bg-[var(--color-surface-secondary)]"
//               style={{ borderRadius: "var(--radius-lg)" }}
//             />
//           </div>
//           <div
//             className="h-72 animate-pulse bg-[var(--color-surface-secondary)]"
//             style={{ borderRadius: "var(--radius-lg)" }}
//           />
//         </div>
//       </div>
...
//             {i < steps.length - 1 && (
//               <div
//                 className="mx-1 mb-4 mt-[18px] h-0.5 flex-1 transition-colors duration-300"
//                 style={{
...
//             className="inline-flex items-center gap-1 px-2 py-1 text-[11px] font-medium text-[var(--color-text-secondary)] transition-colors hover:text-[var(--color-accent)]"
...
//         className="flex w-full items-center justify-between p-3 text-left transition-colors hover:bg-[var(--color-surface-secondary)]"
//       >
...
//               Complete payment with <span className="font-medium">{providerLabel}</span> to begin processing. Items are reserved.
//             </p>
//           </div>
//         </div>
//         <button
...
//           disabled={paying}
//           className={cn(
//             "inline-flex h-11 w-full shrink-0 items-center justify-center gap-1.5 rounded-full px-6 text-[13px] font-semibold text-white transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] active:scale-[0.97] disabled:opacity-60 sm:w-auto",
//             "shadow-[var(--shadow-sm)] hover:shadow-[var(--shadow-md)]"
//           )}
...
//         // Background status sync — fire-and-forget for pending orders
//         if (orderData.status === "pending" && orderData.payment_status === "pending") {
//           fetch(`/api/orders/${id}/status`, {
//             headers: { "Content-Type": "application/json" },
//           }).catch((err) => {
//             console.error("[OrderDetail] Status sync failed:", err);
//           });
//         }
...
//             {/* Header card */}
//             <div
//               className="border border-[var(--color-border)] bg-[var(--color-surface)] p-5 transition-shadow duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:shadow-[var(--shadow-sm)]"
//               style={{ borderRadius: "var(--radius-lg)" }}
//             >
...
//                     <span className="text-[var(--color-accent)]">#</span>{orderRef}
//                   </h1>
...
//                   {order.affiliate_id && (
//                     <StatusPill variant="neutral" icon={Tag}>Affiliate</StatusPill>
//                   )}
//                   {order.integration_source === "shopify" && (
//                     <StatusPill variant="neutral">Shopify</StatusPill>
//                   )}
...
//               <h2 className="px-1 text-[11px] font-medium uppercase tracking-wider text-[var(--color-text-muted)]">
...
//                   <div className="flex justify-between text-[var(--color-text-secondary)]">
//                     <dt>Discount</dt>
//                     <dd className="tabular-nums text-[var(--color-success)] font-medium">
...
//                   </div>
//                 )}
//                 <div className="flex justify-between border-t border-[var(--color-border)] pt-2 text-[14px] font-semibold tracking-tight text-[var(--color-text-primary)]">
//                   <dt>Total</dt>
//                   <dd className="tabular-nums">
...
//                 <button onClick={handleReorder} className={btnSecondary}>
//                   <RotateCcw className="h-3.5 w-3.5" /> Buy again
//                 </button>
//               )}
//               {canCancel && (
//                 <button onClick={() => setCancelOpen(true)} className={btnDestructive}>
...
//     i => i.product_type === "digital" && i.digital_download_url
//   );
...
//           className="text-[11px] font-medium text-[var(--color-text-muted)] transition-colors hover:text-[var(--color-accent)]"
//         >
//           See all →
//         </Link>
//       </div>
...
//                 rel="noopener noreferrer"
//                 {...(downloadable && { download: true })}
//                 className="flex items-center gap-2.5 border border-[var(--color-border)] p-2.5 transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-[var(--color-accent)]/40 hover:bg-[var(--color-accent-light)] hover:shadow-[var(--shadow-sm)]"
//                 style={{ borderRadius: "var(--radius-sm)" }}
//               >
//                 <div
