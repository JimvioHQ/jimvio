    ...
    <div className="bg-[var(--color-bg)] min-h-screen">
      ...
      <section className="py-24 max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div>
            ...
            <div className="space-y-10">
              <div className="flex items-start gap-6">
                <div className="h-14 w-14 rounded-none bg-[var(--color-accent-light)] text-[var(--color-accent)] flex items-center justify-center shrink-0">
              ...
              <div className="flex items-start gap-6">
                <div className="h-14 w-14 rounded-none bg-ink-dark text-white flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <Button variant="outline" className="font-black border-2 rounded-none">Open Chat Now</Button>
                </div>
              </div>

              <div className="flex items-start gap-6">
                <div className="h-14 w-14 rounded-none bg-[var(--color-surface-secondary)] text-[var(--color-text-primary)] flex items-center justify-center shrink-0 border border-[var(--color-border)]">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a href={contact.social_x} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white dark:bg-surface border border-[var(--color-border)] rounded-none flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent)] transition-colors"><Twitter className="h-5 w-5" /></a>
                    <a href={contact.social_youtube} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white dark:bg-surface border border-[var(--color-border)] rounded-none flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent)] transition-colors"><Youtube className="h-5 w-5" /></a>
                    <a href={contact.social_instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white dark:bg-surface border border-[var(--color-border)] rounded-none flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent)] transition-colors"><Globe className="h-5 w-5" /></a>
                    <a href={contact.social_tiktok} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white dark:bg-surface border border-[var(--color-border)] rounded-none flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent)] transition-colors"><Send className="h-5 w-5" /></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Contact Form */}
          <div className="bg-white dark:bg-surface border border-[var(--color-border)] rounded-none p-10 shadow-none">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input placeholder="John Doe" className="h-12 border-2 rounded-none focus-visible:ring-[var(--color-accent)]" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-black capitalize tracking-widest text-[var(--color-text-muted)]">Email Address</label>
                  <Input placeholder="john@example.com" className="h-12 border-2 rounded-none focus-visible:ring-[var(--color-accent)]" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-xs font-black capitalize tracking-widest text-[var(--color-text-muted)]">Subject</label>
                <select className="w-full h-12 border-2 rounded-none px-4 bg-white dark:bg-surface font-bold outline-none focus:border-[var(--color-accent)] transition-colors">
              ...
              <div className="space-y-2">
                ...
                <Textarea placeholder="How can we help you?" className="min-h-[150px] border-2 rounded-none focus-visible:ring-[var(--color-accent)]" />
              </div>
      ...
      <section className="py-24 bg-[var(--color-surface-secondary)] border-y border-[var(--color-border)]">
        <div className="max-w-[var(--container-max)] mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="aspect-[21/9] bg-white dark:bg-surface border border-[var(--color-border)] rounded-none shadow-none flex items-center justify-center">
