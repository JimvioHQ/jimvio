    ...
    <div className="bg-[var(--color-bg)] min-h-screen">
      ...
      <section className="py-24 max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a href={contact.social_x} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white dark:bg-surface border border-[var(--color-border)] rounded-lg flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent)] transition-colors"><Twitter className="h-5 w-5" /></a>
                    <a href={contact.social_youtube} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white dark:bg-surface border border-[var(--color-border)] rounded-lg flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent)] transition-colors"><Youtube className="h-5 w-5" /></a>
                    <a href={contact.social_instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white dark:bg-surface border border-[var(--color-border)] rounded-lg flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent)] transition-colors"><Globe className="h-5 w-5" /></a>
                    <a href={contact.social_tiktok} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white dark:bg-surface border border-[var(--color-border)] rounded-lg flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent)] transition-colors"><Send className="h-5 w-5" /></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Contact Form */}
          <div className="bg-white dark:bg-surface border border-[var(--color-border)] rounded-[2.5rem] p-10 shadow-2xl">
            ...
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full h-12 border-2 rounded-xl px-4 bg-white dark:bg-surface font-bold outline-none focus:border-[var(--color-accent)] transition-colors">
      ...
      <section className="py-24 bg-[var(--color-surface-secondary)] border-y border-[var(--color-border)]">
        <div className="max-w-[var(--container-max)] mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="aspect-[21/9] bg-white dark:bg-surface border border-[var(--color-border)] rounded-[3rem] shadow-sm flex items-center justify-center">
