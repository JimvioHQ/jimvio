        ...
        <div className="max-w-[var(--container-max,1400px)] mx-auto px-5 sm:px-8 py-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <div className="relative flex-1 max-w-2xl group">
            ...
            <input
              ...
              className="w-full h-10 pl-10 pr-4 bg-white border border-[#E2DFD8] rounded-lg text-[14px] text-[#1A1917] placeholder:text-[#8A8780] focus:outline-none focus:border-[#1A1917] focus:ring-2 focus:ring-[#1A1917]/6 transition-all font-medium"
            />
          </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="relative">
              <button
                ...
                className="h-10 px-4 flex items-center gap-2 rounded-lg bg-white border border-[#E2DFD8] text-[13px] font-semibold text-[#1A1917] hover:border-[#CCC9C0] hover:bg-[#F8F7F4] transition-all whitespace-nowrap"
              >
              ...
              {typeDropdownOpen && (
                <>
                  ...
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-[#E2DFD8] rounded-xl shadow-lg shadow-black/5 z-50 overflow-hidden py-1">
            ...
            <div className="relative">
              ...
              {sortDropdownOpen && (
                <>
                  ...
                  <div className="absolute top-full left-0 mt-2 w-44 bg-white border border-[#E2DFD8] rounded-xl shadow-lg shadow-black/5 z-50 overflow-hidden py-1">
            ...
            <div className="hidden sm:flex items-center gap-1.5 pl-3 border-l border-[#E2DFD8] ml-1">
              <button className="h-9 w-9 rounded-lg bg-white border border-[#E2DFD8] flex items-center justify-center text-[#8A8780] hover:text-[#FF0000] hover:border-[#CCC9C0] transition-all">
                <Youtube className="h-[15px] w-[15px]" />
              </button>
              <button className="h-9 w-9 rounded-lg bg-white border border-[#E2DFD8] flex items-center justify-center text-[#8A8780] hover:text-black hover:border-[#CCC9C0] transition-all">
              ...
              <button className="h-9 w-9 rounded-lg bg-white border border-[#E2DFD8] flex items-center justify-center text-[#8A8780] hover:text-[#E1306C] hover:border-[#CCC9C0] transition-all">
          ...
          {activeItem.itemType === "clipping" ? (
            <div className="relative w-full h-full flex flex-col">
              <button
                ...
                className="absolute top-5 right-5 z-50 h-10 w-10 bg-white/10 hover:bg-white/20 text-white rounded-full flex items-center justify-center transition-all border border-white/20"
              >
                <X className="h-5 w-5" />
              </button>
            ...
            <>
              ...
              <div className="relative w-full max-w-lg max-h-[90vh] p-4 flex flex-col">
                <button
                  onClick={() => setActiveItem(null)}
                  className="absolute -top-4 right-4 h-9 w-9 bg-white text-[#1A1917] rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-all z-10"
                >
                  <X className="h-4 w-4" />
                </button>
                <div className="bg-white rounded-2xl overflow-hidden shadow-2xl border border-[#E2DFD8]">
...
function EmptyState() {
  return (
    <div className="py-28 text-center border-2 border-dashed border-[#E2DFD8] rounded-2xl bg-white/50">
...
function ContentCard({
  ...
  return (
    <button
      ...
      className={`text-left group flex flex-col bg-white border border-[#E2DFD8] hover:border-[#CCC9C0] rounded-2xl overflow-hidden transition-all duration-300 w-full hover:shadow-lg hover:shadow-black/5 appearance-none outline-none focus-visible:ring-2 focus-visible:ring-[#1A1917]/20`}
    >
      {/* Image */}
      <div className={`relative w-full ${featured ? "aspect-[16/10]" : "aspect-[4/3]"} bg-[#F1EFE8] overflow-hidden`}>
        ...
        <div className="absolute top-3 left-3">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white/95 backdrop-blur-md rounded-md text-[11px] font-semibold text-[#1A1917] tracking-wide uppercase">
        ...
        <div className="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          <span className="inline-flex items-center gap-1 px-2 py-1 bg-black/60 backdrop-blur-md rounded-md text-[11px] font-semibold text-white">
      ...
      <div className="flex flex-col flex-1 p-4">
        ...
        {/* Progress bar */}
        <div className="mt-3 h-[3px] bg-[#F1EFE8] rounded-full overflow-hidden">
          <div
            className={`h-full rounded-full ${isUGC ? "bg-[#D85A30]/60" : "bg-[#1A1917]/40"}`}
            style={{ width: "72%" }}
          />
        </div>
      </div>
