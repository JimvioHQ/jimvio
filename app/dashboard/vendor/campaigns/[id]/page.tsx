        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="p-8 rounded-[40px] bg-zinc-950 text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-6">
                   <div className="flex items-center justify-between">
                      ...
                      <div className="px-3 py-1 rounded-full bg-white dark:bg-surface/10 border border-white/10 text-[10px] font-black">
                   ...
                   <div className="space-y-3">
                      ...
                      <div className="h-3 w-full bg-white dark:bg-surface/5 rounded-full overflow-hidden border border-white/5">
                         <div 
           ...
           <div className="lg:col-span-4 space-y-6">
              ...
              <Link
                ...
                className="group flex flex-col p-8 rounded-[40px] bg-white dark:bg-surface text-zinc-950 shadow-2xl relative overflow-hidden transition-all hover:scale-[1.02] active:scale-95"
              >
