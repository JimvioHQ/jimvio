...
export default function VendorAnalyticsPage() {
  ...
  const totalRevenueLabel = useMemo(() => {
    if (!revenueLineItems.length) return "â€”";
      ...
      <div className="max-w-[1440px] mx-auto space-y-12 px-8 pt-12 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
           ...
           <GlassCard className="p-8 flex flex-col justify-between rounded-none bg-white dark:bg-surface/60 border-white shadow-none group">
              ...
              <div>
                 <p className="text-3xl font-black text-emerald-600 tracking-tighter leading-none tabular-nums truncate max-w-full">{totalRevenueLabel === "â€”" ? "$0" : totalRevenueLabel}</p>
