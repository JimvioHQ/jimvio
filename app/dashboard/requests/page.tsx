              ...
              <GlassCard className="p-12 rounded-[56px] border-white bg-white/60 shadow-2xl relative overflow-hidden">
                 ...
                 <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-12 gap-x-10 gap-y-8">
                    ...
                    <div className="md:col-span-12 flex justify-end pt-6">
                       <Button type="submit" disabled={submitting} className="h-20 px-12 rounded-[32px] bg-stone-900 text-white font-black text-[12px] uppercase tracking-[0.4em] shadow-2xl shadow-stone-900/40 active:scale-95 transition-all hover:bg-black border-none">
                      ...
                      >
                        <div className="space-y-8">
                           <div className="flex items-start justify-between">
                              ...
                              <GlassPill color={lead.status === "open" ? "sky" : lead.status === "awarded" ? "emerald" : "default"} className="font-black text-[10px] px-4 py-2 border-white shadow-sm ring-1 ring-white">
