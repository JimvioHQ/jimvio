      ...
      <div className="max-w-[1440px] mx-auto space-y-12 px-8 pt-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           <div className="lg:col-span-12">
              <GlassCard className="relative p-0 overflow-hidden border-white bg-white dark:bg-surface/70 shadow-2xl rounded-[48px]">
                 <div className="grid grid-cols-1 lg:grid-cols-3">
                    ...
                    <div className="p-12 bg-stone-50/30 flex flex-col justify-between items-start">
                       <div className="space-y-6">
                          <div className="w-14 h-14 rounded-2xl bg-white dark:bg-surface border border-white shadow-sm flex items-center justify-center text-emerald-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 pt-12 border-t border-stone-100 dark:border-border" id="settlement-trigger">
           ...
           <div className="space-y-8">
              ...
              <GlassCard className="p-10 space-y-10 rounded-[48px] bg-white dark:bg-surface/60 border-white shadow-2xl">
                 {withdrawSuccess && (
                 ...
                 <div className="space-y-6">
                    ...
                    <div className="relative group">
                       ...
                       <Input
                         ...
                         className="h-20 rounded-[32px] bg-white dark:bg-surface border-stone-200 dark:border-border focus:ring-8 focus:ring-emerald-500/5 focus:border-emerald-400 text-4xl font-black tracking-tighter px-10 transition-all shadow-xl tabular-nums placeholder:text-stone-100"
                       />
                    </div>
                 ...
                 <div className="p-8 rounded-[32px] bg-stone-50/50 border border-stone-100 dark:border-border flex items-start gap-4">
                    <div className="p-2 rounded-xl bg-white dark:bg-surface border border-stone-100 dark:border-border text-stone-300 shadow-sm mt-1">
           ...
           <div className="space-y-8">
              ...
              <GlassCard className="p-10 space-y-10 rounded-[48px] bg-white dark:bg-surface/40 border-white/80 h-[calc(100%-80px)] flex flex-col justify-between shadow-xl">
                 <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                       ...
                       <Input
                        ...
                        className="h-16 rounded-[32px] bg-white dark:bg-surface border-stone-100 dark:border-border focus:ring-8 focus:ring-sky-500/5 focus:border-sky-400 text-base font-black tracking-[0.2em] px-8 transition-all shadow-lg font-mono placeholder:text-stone-100"
                       />
                       {syncOrderMsg && (
                 ...
                 <Button 
                    ...
                    className="h-20 w-full rounded-[40px] bg-white dark:bg-surface border border-stone-100 dark:border-border text-stone-900 dark:text-white font-black text-[12px] uppercase tracking-[0.4em] shadow-xl active:scale-95 transition-all hover:bg-stone-50 dark:bg-surface/50"
                 >
        ...
        <div className="space-y-8 pt-12 border-t border-stone-100 dark:border-border">
           ...
           <GlassCard className="p-0 overflow-hidden border-white bg-white dark:bg-surface/40 shadow-2xl rounded-[48px]">
              <div className="overflow-x-auto">
                 {payouts.length === 0 ? (
                    <div className="p-32 text-center space-y-8 animate-in fade-in duration-700">
                       <div className="w-24 h-24 rounded-[40px] bg-white dark:bg-surface border border-stone-100 dark:border-border flex items-center justify-center mx-auto shadow-2xl shadow-stone-900/5">
                          ...
                          {payouts.map((p) => (
                             <tr key={p.id as string} className="group hover:bg-white dark:bg-surface/80 transition-all duration-500">
                                ...
                                <td className="px-10 py-12 text-center">
                                   <div className="inline-flex items-center gap-3 bg-white dark:bg-surface px-4 py-2 rounded-xl border border-stone-100 dark:border-border shadow-sm">
