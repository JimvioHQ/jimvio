      ...
      <div className="max-w-[1440px] mx-auto space-y-12 px-8 pt-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
           ...
           <div className="flex items-center gap-4 bg-white dark:bg-surface/40 p-1.5 rounded-sm border border-white shadow-none backdrop-blur-xl">
              <div className="w-3 h-3 rounded-sm bg-emerald-500 ml-4 animate-pulse shadow-[0_0_12px_rgba(16,185,129,0.5)]" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
           ...
           <GlassCard className="p-8 flex flex-col justify-between rounded-sm bg-white dark:bg-surface/60 border-white shadow-none group">
              <div className="w-14 h-14 rounded-sm bg-indigo-50 border border-indigo-100 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           <GlassCard className="lg:col-span-8 rounded-sm border-white bg-white dark:bg-surface/60 shadow-none overflow-hidden group">
              <div className="p-10 border-b border-stone-100 dark:border-border flex items-center justify-between">
                 ...
                 <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-stone-500">
                       <div className="w-2.5 h-2.5 rounded-sm bg-orange-500 shadow-[0_0_8px_rgba(249,115,22,0.6)]" /> Signal Flow
                    </div>
                 </div>
              </div>
           ...
           <GlassCard className="lg:col-span-4 rounded-sm border-white bg-white dark:bg-surface/60 shadow-none overflow-hidden flex flex-col">
              <div className="p-10 border-b border-stone-100 dark:border-border">
              ...
              <div className="p-10 space-y-8 flex-1">
                 {links.slice(0, 6).map((l, i) => (
                    <div key={l.id} className="space-y-3 group/item">
                       ...
                       <div className="h-3 bg-white dark:bg-surface border border-stone-50 rounded-sm overflow-hidden shadow-none">
                          <div 
                             className="h-full bg-stone-900 rounded-sm transition-all duration-[2000ms] ease-out group-hover/item:bg-orange-500" 
        ...
        <GlassCard className="rounded-sm border-white bg-white dark:bg-surface/60 shadow-none overflow-hidden">
           <div className="p-10 border-b border-stone-100 dark:border-border flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <Button className="h-14 px-8 rounded-sm bg-white dark:bg-surface text-stone-900 dark:text-white border-white shadow-none font-black text-[11px] uppercase tracking-widest active:scale-95 transition-all hover:bg-stone-50 dark:bg-surface/50">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-stone-50/40">
                    <th className="py-8 pl-10 pr-6 text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 border-b border-stone-100 dark:border-border">Target Node / Link</th>
                    <th className="py-8 px-6 text-right text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 border-b border-stone-100 dark:border-border">Frequency</th>
                    <th className="py-8 px-6 text-right text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 border-b border-stone-100 dark:border-border">Unique Identity</th>
                    <th className="py-8 px-6 text-right text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 border-b border-stone-100 dark:border-border">Yield %</th>
                    <th className="py-8 px-6 text-center text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 border-b border-stone-100 dark:border-border">Status</th>
                  ...
                  {links.map(l => (
                    <tr key={l.id} className="hover:bg-white dark:bg-surface/80 transition-all duration-500 group">
                      ...
                      <td className="px-6 py-10 text-center">
                         <GlassPill color="emerald" className="mx-auto px-4 py-2 font-black border-white shadow-none">ACTIVE</GlassPill>
                      </td>
                      <td className="pr-10 py-10 text-right">
                         <Button variant="ghost" size="icon" className="h-12 w-12 rounded-sm bg-white dark:bg-surface border border-transparent group-hover:bg-stone-900 group-hover:text-white transition-all shadow-none active:scale-90">
