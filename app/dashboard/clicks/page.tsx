      ...
      <div className="min-h-screen flex flex-col items-center justify-center space-y-12 animate-in fade-in duration-700" style={{ background: "#f0ede8" }}>
        <div className="relative">
          ...
          <div className="relative w-24 h-24 rounded-[32px] bg-white border border-white shadow-2xl flex items-center justify-center overflow-hidden">
            ...
            <MousePointer className="h-10 w-10 text-stone-900" />
          </div>
        </div>
        <div className="text-center space-y-3">
           <h2 className="text-[14px] font-black text-stone-900 uppercase tracking-[0.4em] pl-[0.4em]">Signal Acquisition</h2>
      ...
      <div className="max-w-[1440px] mx-auto space-y-12 px-8 pt-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
           ...
           <div className="flex items-center gap-4 bg-white/40 p-1.5 rounded-full border border-white shadow-xl backdrop-blur-xl">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-stone-900 pr-6 pl-2">Live Node Tracking</span>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
           <GlassCard className="p-8 flex flex-col justify-between rounded-[40px] bg-white/60 border-white shadow-xl group">
              ...
              <div>
                 <p className="text-4xl font-black text-stone-900 tracking-tighter leading-none">{totalClicks.toLocaleString()}</p>
           ...
           <GlassCard className="p-8 flex flex-col justify-between rounded-[40px] bg-white/60 border-white shadow-xl group">
              ...
              <div>
                 <p className="text-4xl font-black text-stone-900 tracking-tighter leading-none">{totalUnique.toLocaleString()}</p>
           ...
           <GlassCard className="p-8 flex flex-col justify-between rounded-[40px] bg-white/60 border-white shadow-xl group">
              ...
              <div>
                 <p className="text-4xl font-black text-stone-900 tracking-tighter leading-none">4.5%</p>
           ...
           <GlassCard className="p-8 flex flex-col justify-between rounded-[40px] bg-white/60 border-white shadow-xl group">
              ...
              <div>
                 <p className="text-4xl font-black text-stone-900 tracking-tighter leading-none">72% Mobile</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           <GlassCard className="lg:col-span-8 rounded-[48px] border-white bg-white/60 shadow-xl overflow-hidden group">
              <div className="p-10 border-b border-stone-100 flex items-center justify-between">
                 <div>
                    <h3 className="text-2xl font-black text-stone-900 tracking-tighter">Signal Propagation Matrix</h3>
           ...
           <GlassCard className="lg:col-span-4 rounded-[48px] border-white bg-white/60 shadow-xl overflow-hidden flex flex-col">
              <div className="p-10 border-b border-stone-100">
                 <h3 className="text-2xl font-black text-stone-900 tracking-tighter">Target Referrals</h3>
                 ...
                 {links.slice(0, 6).map((l, i) => (
                    <div key={l.id} className="space-y-3 group/item">
                       <div className="flex items-center justify-between">
                          <span className="font-black text-stone-900 tracking-tight truncate max-w-[180px]">{l.products?.name || l.link_code}</span>
                          <span className="font-black text-stone-400 text-[11px] uppercase tracking-widest">{(l.total_clicks || 0).toLocaleString()} Pulse</span>
                       </div>
                       <div className="h-3 bg-white border border-stone-50 rounded-full overflow-hidden shadow-sm">
                          <div 
        ...
        <GlassCard className="rounded-[48px] border-white bg-white/60 shadow-xl overflow-hidden">
           <div className="p-10 border-b border-stone-100 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="space-y-1">
                 <h3 className="text-3xl font-black text-stone-900 tracking-tighter">Detailed Node Registry</h3>
                 <p className="text-[11px] font-black uppercase tracking-widest text-stone-400">Granular Link Performance Matrix</p>
              </div>
              <Button className="h-14 px-8 rounded-full bg-white text-stone-900 border-white shadow-xl font-black text-[11px] uppercase tracking-widest active:scale-95 transition-all hover:bg-stone-50">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-stone-50/40">
                    <th className="py-8 pl-10 pr-6 text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 border-b border-stone-100">Target Node / Link</th>
                    <th className="py-8 px-6 text-right text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 border-b border-stone-100">Frequency</th>
                    <th className="py-8 px-6 text-right text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 border-b border-stone-100">Unique Identity</th>
                    <th className="py-8 px-6 text-right text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 border-b border-stone-100">Yield %</th>
                    ...
                    <tr key={l.id} className="hover:bg-white/80 transition-all duration-500 group">
                      <td className="pl-10 pr-6 py-10">
                        <div className="space-y-1.5">
                           <p className="text-xl font-black text-stone-900 tracking-tighter">{l.products?.name || "Global Deployment"}</p>
                      ...
                      <td className="px-6 py-10 text-right">
                         <p className="text-2xl font-black text-stone-900 tabular-nums tracking-tighter">{(l.total_clicks || 0).toLocaleString()}</p>
                      ...
                      <td className="px-6 py-10 text-right">
                         <p className="text-xl font-black text-stone-900 tracking-tighter">24%</p>
