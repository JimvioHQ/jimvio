        ...
        <GlassCard className="p-10 relative overflow-hidden">
           ...
           <div className="space-y-4">
              ...
              >
                 ...
                 {agreedToGuidelines ? <CheckCircle className="h-5 w-5 text-emerald-500" /> : <div className="w-5 h-5 rounded-full border-2 border-stone-200 dark:border-border group-hover/btn:border-violet-300 transition-colors" />}
              </button>
           </div>
