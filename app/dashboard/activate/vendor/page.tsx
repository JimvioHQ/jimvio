...
//       }}
//     >
//       <div className="max-w-[700px] mx-auto space-y-6 sm:space-y-8 px-4 sm:px-6 pt-6 sm:pt-10 relative z-10">

//         {/* Header - Simpler */}
//         <div className="flex flex-col items-center text-center space-y-4">
//            <Button asChild variant="ghost" className="rounded-xl bg-white dark:bg-surface border border-stone-100 dark:border-border shadow-sm hover:bg-stone-50 dark:bg-surface/50 active:scale-95 transition-all h-10 px-6">
...
//              <GlassCard className="p-5 sm:p-8 rounded-2xl border border-stone-100 dark:border-border bg-white dark:bg-surface/60 shadow-sm relative overflow-hidden">
//                 <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
//                    <div className="md:col-span-4 flex justify-center">
//                       <div className={cn(
//                         "w-16 h-16 sm:w-24 sm:h-24 rounded-2xl flex items-center justify-center shrink-0 border-2 border-white shadow-sm transition-all duration-700",
...
//                    <div className="mt-6 sm:mt-8 p-4 sm:p-6 rounded-xl bg-rose-50/50 dark:bg-rose-950/20 border border-rose-100 dark:border-rose-900/30">
...
//                       ].map((step, i) => (
//                         <div key={i} className="p-4 sm:p-5 rounded-xl bg-white dark:bg-surface/40 border border-stone-100 dark:border-border shadow-sm flex flex-col items-center gap-3 text-center">
//                            <div className="w-10 h-10 rounded-xl bg-white dark:bg-surface border border-stone-100 dark:border-border flex items-center justify-center text-orange-500 shadow-sm">
//                               {step.icon}
//                            </div>
...
//                 <div className="mt-6 sm:mt-10 pt-6 sm:pt-6 sm:pt-8 border-t border-stone-100 dark:border-border flex flex-wrap items-center justify-center md:justify-start gap-2 sm:gap-3">
//                    <Button asChild className="h-10 sm:h-12 px-5 sm:px-8 rounded-xl bg-stone-900 text-white font-bold text-xs uppercase tracking-widest shadow-sm hover:bg-black active:scale-95 transition-all border-none">
//                       <Link href="/dashboard"><LayoutDashboard className="h-4 w-4 mr-2" /> Dashboard</Link>
//                    </Button>

//                    {(statusKey === "approved" || statusKey === "verified") && (
//                      <>
//                         <Button asChild variant="outline" className="h-10 sm:h-12 px-5 sm:px-8 rounded-xl border-stone-100 dark:border-border text-stone-900 dark:text-white font-bold text-xs uppercase tracking-widest active:scale-95 transition-all">
...
//           </div>
//         ) : (
//           <GlassCard className="rounded-2xl border border-stone-100 dark:border-border bg-white dark:bg-surface/60 shadow-sm overflow-hidden">

//              {/* Simple Step Bar */}
//              <div className="p-4 sm:p-8 border-b border-stone-100 dark:border-border bg-white dark:bg-surface/40 backdrop-blur-2xl">
...
//                             <div className={cn(
//                                "w-9 h-9 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center text-sm font-bold transition-all duration-700 border-2 sm:border-4 border-white shadow-sm relative",
...
//                              className="h-11 sm:h-12 rounded-xl bg-white dark:bg-surface border-stone-100 dark:border-border shadow-none focus:ring-4 focus:ring-orange-500/5 focus:border-orange-400 text-base font-bold px-5 transition-all"
//                              required
//                            />
//                         </div>
...
//                                 className="h-11 sm:h-12 rounded-xl bg-white dark:bg-surface border-stone-100 dark:border-border shadow-none focus:ring-4 focus:ring-orange-500/5 focus:border-orange-400 text-sm font-bold px-5 transition-all"
//                               />
//                            </div>
//                            <div className="space-y-3">
...
//                                    className="w-full h-11 sm:h-12 pl-12 pr-6 rounded-xl border border-stone-100 dark:border-border bg-white dark:bg-surface shadow-sm text-sm font-bold focus:outline-none focus:ring-4 focus:ring-orange-500/5 focus:border-orange-400 transition-all placeholder:text-stone-100"
//                                  />
//                                  {categoryDropdownOpen && (
//                                    <div className="absolute top-full left-0 right-0 mt-2 max-h-56 overflow-auto rounded-xl border border-stone-100 dark:border-border bg-white dark:bg-surface shadow-none z-50 p-2 animate-in fade-in zoom-in-95 duration-200">
...
//                              rows={3}
//                              className="rounded-xl bg-white dark:bg-surface border-stone-100 dark:border-border shadow-sm focus:ring-4 focus:ring-orange-500/5 focus:border-orange-400 text-sm font-bold px-4 sm:px-5 py-4 transition-all resize-none"
//                            />
//                         </div>
//                      </div>
//                   </div>
...
//                              className="h-11 sm:h-12 rounded-xl bg-white dark:bg-surface border-stone-100 dark:border-border shadow-none focus:ring-4 focus:ring-sky-500/5 focus:border-sky-400 text-base font-bold px-5"
//                            />
//                         </div>
//                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                            <div className="space-y-3">
...
//                                 className="h-11 sm:h-12 w-full px-4 sm:px-5 rounded-xl border border-stone-100 dark:border-border bg-white dark:bg-surface shadow-sm text-sm font-bold focus:outline-none focus:ring-4 focus:ring-sky-500/5 focus:border-sky-400 transition-all"
//                               >
...
//                                 placeholder="+250..."
//                                 className="h-11 sm:h-12 rounded-xl bg-white dark:bg-surface border-stone-100 dark:border-border shadow-none focus:ring-4 focus:ring-sky-500/5 focus:border-sky-400 text-sm font-bold px-5"
//                               />
//                            </div>
//                         </div>
//                         <div className="space-y-3">
...
//                         ].map((row, i) => (
//                           <div key={i} className="px-4 sm:px-6 py-3 sm:py-4 rounded-xl bg-white dark:bg-surface border border-stone-100 dark:border-border shadow-sm flex items-center justify-between group hover:border-orange-100 transition-all">
...
//                         ))}
//                      </div>
//                      <div className="p-4 sm:p-6 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/50 flex items-start gap-3">
...
//                 {/* Footer Nav */}
//                 <div className="flex items-center justify-between gap-4 pt-6 sm:pt-8 border-t border-stone-100 dark:border-border">
//                    <Button
//                      type="button"
//                      variant="ghost"
//                      onClick={() => setStep(s => s - 1)}
//                      disabled={step === 1 || submitting}
//                      className="h-11 sm:h-12 px-4 sm:px-6 rounded-xl font-bold text-[11px] uppercase tracking-widest text-stone-400 hover:text-stone-900 dark:text-white transition-all"
//                    >
...
//                           setStep(s => s + 1);
//                        }}
//                        className="h-11 sm:h-12 px-6 sm:px-8 rounded-xl bg-stone-900 text-white font-bold text-[11px] uppercase tracking-widest shadow-sm active:scale-95 transition-all outline-none border-none"
//                      >
...
export default function ActivateVendorPage() {
   ...
   useEffect(() => {
      (async () => {
         ...
         const list = (data ?? []).map(c => ({ ...c, sort_order: c.sort_order ?? 0 }))
