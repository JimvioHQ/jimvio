      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex-1 space-y-6 w-full min-w-0">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
             ...
             <div className="flex items-center gap-3">
                <a
                  ...
                  className="h-10 px-5 rounded-xl bg-orange-50/50 border border-orange-100/50 text-orange-600 font-black text-[10px] uppercase tracking-widest flex items-center gap-2 hover:bg-orange-50 transition-all active:scale-95"
                >
                ...
                {(sub.status === "pending" || sub.status === "rejected") && (
                  <button
                    ...
                    className="h-10 w-10 flex items-center justify-center rounded-xl bg-rose-50 border border-rose-100/50 text-rose-500 hover:bg-rose-100 transition-all opacity-0 group-hover:opacity-100 active:scale-90"
                  >
          ...
          {sub.status === "rejected" && sub.rejection_reason && (
            <div className="p-5 rounded-[24px] bg-rose-50 border border-rose-100 text-[11px] font-bold text-rose-600 leading-relaxed shadow-inner">
