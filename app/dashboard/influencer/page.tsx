            ...
            {recentSubmissions.length === 0 ? (
               <GlassCard className="py-24 text-center border-dashed border-border bg-surface dark:bg-surface/20">
                  ...
                  <Link href="/ugc" className="mt-6 inline-block">
                     <Button className="h-11 px-8 rounded-none bg-surface dark:bg-surface border border-border text-stone-700 dark:text-stone-300 font-bold text-[11px] uppercase tracking-widest shadow-none hover:bg-surface-secondary dark:hover:bg-zinc-800 transition-all">Browse Missions →</Button>
                  </Link>
               </GlassCard>
            ) : (
