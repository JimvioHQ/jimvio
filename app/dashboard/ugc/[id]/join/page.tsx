  ...
  return (
    <div className="max-w-5xl mx-auto space-y-12 pb-20">
       <div className="flex flex-col md:flex-row items-center gap-8 bg-zinc-950 rounded-[48px] p-8 md:p-12 text-white relative overflow-hidden shadow-2xl">
          ...
          <div className="relative shrink-0 w-32 h-32 md:w-40 md:h-40 rounded-[40px] bg-white p-0.5 overflow-hidden shadow-2xl">
          ...
          <div className="relative space-y-4 text-center md:text-left flex-1">
             ...
             <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                ...
                {campaign.max_payout_per_sub && (
                   <div className="px-4 py-2 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-2 text-white/60">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
             ...
             <div className="space-y-3">
                {[
                   ...
                   <div key={i} className="flex items-center gap-4 p-5 rounded-[28px] bg-white border border-zinc-100 shadow-sm">
                      ...
                      <p className="text-sm font-black text-zinc-700 leading-tight uppercase tracking-tight">{r.label}</p>
                   </div>
                ))}
             </div>
          </div>
          ...
          <div className="space-y-6">
             ...
             <div className="grid grid-cols-1 gap-4">
                {STEPS.map((s, i) => (
                   <div key={i} className="flex items-center gap-4 p-4 rounded-[28px] bg-white border border-zinc-50 shadow-sm relative group hover:border-orange-200 transition-all">
                      <div className="w-10 h-10 rounded-2xl bg-zinc-50 border border-zinc-100 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                         <s.icon className="h-4 w-4 text-zinc-900" />
                      </div>
                      <div className="flex-1">
                         <h3 className="font-black text-zinc-900 text-xs leading-none uppercase tracking-widest">{s.title}</h3>
          ...
          <div className="max-w-md mx-auto space-y-6 text-center">
             <label className="flex items-center gap-4 cursor-pointer group">
                <div className={cn(
                   ...
                   agreed ? "bg-zinc-950 border-zinc-950 shadow-lg" : "bg-white border-zinc-200 group-hover:border-zinc-400"
                )}>
                ...
                <span className="text-left text-[11px] font-black text-zinc-700 select-none leading-tight uppercase tracking-tight">
