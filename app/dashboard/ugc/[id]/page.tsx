    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row items-end md:items-center justify-between gap-6">
         <div className="flex items-center gap-6">
            <div className="w-20 h-20 rounded-3xl bg-white border border-zinc-100 p-0.5 shadow-xl shrink-0 overflow-hidden">
               <img src={campaign.media?.[0]?.url || "/hero-bg.png"} className="w-full h-full object-cover rounded-[22px]" alt="" />
            </div>
            <div className="space-y-1">
               <h1 className="text-3xl md:text-5xl font-black tracking-tight leading-none text-zinc-900">{campaign.title}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
         <div className="lg:col-span-8 space-y-6">
            <h2 className="text-xl font-black text-zinc-900 tracking-tight flex items-center gap-2 px-2">
            ...
            {submissions.length === 0 ? (
               ...
               <div className="space-y-4">
                  {submissions.map((s) => {
                     ...
                     return (
                        <div key={s.id} className="p-4 rounded-[32px] bg-white border border-zinc-100 shadow-sm transition-all group overflow-hidden">
                           <div className="flex items-center gap-5">
                              ...
                              <div className="flex-1 space-y-2 py-1">
                                 ...
                                 <div className="space-y-0.5">
                                    <a href={s.post_url} target="_blank" className="text-sm font-black text-zinc-900 flex items-center gap-1.5">
         ...
         <div className="lg:col-span-4 space-y-6">
            <div className="p-8 rounded-[40px] bg-white border border-zinc-100 shadow-sm space-y-8">
               ...
               <Button asChild variant="outline" className="w-full h-12 rounded-2xl border-zinc-100 font-black text-xs uppercase tracking-widest">
