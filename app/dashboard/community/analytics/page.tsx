    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto space-y-12 px-8 pt-12 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
           <GlassCard className="p-8 flex flex-col justify-between rounded-sm bg-white dark:bg-surface/60 border-white shadow-none group transition-all duration-700 hover:scale-105">
           ...
           <div className="p-12 border-b border-stone-100 dark:border-border flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex items-center gap-6">
                 <div className="flex items-center gap-3">
                    <div className="w-3 h-3 rounded-sm bg-teal-500 shadow-[0_0_10px_rgba(20,184,166,0.6)]" />
                    <span className="text-[10px] font-black uppercase tracking-widest text-stone-400">Interactions</span>
                 </div>
                 <div className="flex items-center gap-3">
                    <div className="w-3 h-3 rounded-sm bg-orange-500 shadow-[0_0_10px_rgba(249,115,22,0.6)]" />
        ...
        {/* Promotion card */}
        <GlassCard className="p-12 rounded-sm border-white bg-stone-900 text-white relative overflow-hidden shadow-none">
           <div className="absolute top-0 right-0 w-80 h-80 bg-orange-500/20 blur-[120px] rounded-sm translate-x-1/2 -translate-y-1/2" />
           <div className="flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
              ...
              <Button className="h-20 px-12 rounded-sm bg-white dark:bg-surface text-stone-900 dark:text-white font-black text-[12px] uppercase tracking-[0.3em] shadow-none active:scale-95 transition-all hover:bg-stone-50 dark:bg-surface/50 border-none">
