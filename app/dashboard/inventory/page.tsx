  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center space-y-4" style={{ background: "var(--color-bg)" }}>
        ...
        <p className="text-[11px] font-bold text-stone-400 dark:text-stone-500 capitalize pl-1">Loading Inventory...</p>
      </div>
    );
  }
  ...
  if (!vendor) {
    return (
      <div className="min-h-screen flex items-center justify-center px-6" style={{ background: "var(--color-bg)" }}>
        <div className="max-w-md w-full p-10 text-center space-y-8 bg-surface dark:bg-zinc-900 rounded-[32px] border border-border shadow-sm">
          <div className="w-16 h-16 bg-surface-secondary dark:bg-zinc-800 rounded-2xl flex items-center justify-center mx-auto border border-border">
          ...
          <div className="space-y-2">
            ...
            <p className="text-stone-400 dark:text-stone-500 text-[13px] font-medium leading-relaxed">Please register as a vendor to manage your product inventory.</p>
          </div>
          <Button asChild className="w-full h-12 rounded-xl bg-stone-900 dark:bg-white dark:bg-zinc-900 text-white dark:text-stone-900 dark:text-white hover:bg-black dark:hover:bg-stone-100 font-bold active:scale-95 transition-all text-[11px] capitalize border-none">
         ...
         <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
            <div className="flex items-center gap-3 sm:gap-4">
               ...
               <div className="space-y-0.5">
                  ...
                  <p className="text-[10px] sm:text-[11px] font-bold text-stone-400 dark:text-stone-500 uppercase tracking-widest leading-none pl-0.5 opacity-80">Track and manage your physical stock</p>
               </div>
            </div>
                      <div className="flex items-center gap-2">
               <Button asChild className="h-9 sm:h-10 px-6 rounded-xl bg-stone-900 dark:bg-white dark:bg-zinc-900 text-white dark:text-stone-900 dark:text-white font-bold text-[9px] sm:text-[10px] uppercase tracking-widest shadow-md active:scale-95 transition-all hover:bg-black dark:hover:bg-stone-100 border-none">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
            <div className="p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-surface/60 dark:bg-zinc-800/40 border border-border shadow-sm flex items-center gap-4">
               ...
               <div>
                  ...
                  <p className="text-[9px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-500 mt-1">Total Units</p>
               </div>
            </div>
            <div className="p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-surface/60 dark:bg-zinc-800/40 border border-border shadow-sm flex items-center gap-3 sm:gap-4">
               ...
               <div>
                  ...
                  <p className="text-[9px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-500 mt-1">Low Stock</p>
               </div>
            </div>
            <div className="p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-surface/60 dark:bg-zinc-800/40 border border-border shadow-sm flex items-center gap-3 sm:gap-4">
               ...
               <div>
                  ...
                  <p className="text-[9px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-500 mt-1">Out of Stock</p>
               </div>
            </div>
        </div>

        {/* Inventory Table - Full-width Mobile */}
         <GlassCard className="rounded-2xl sm:rounded-[32px] border-border max-sm:-mx-4 max-sm:rounded-none max-sm:border-x-0 bg-surface/60 dark:bg-zinc-800/40 backdrop-blur-md shadow-sm overflow-hidden text-left">
            <div className="p-4 sm:p-8 border-b border-border bg-surface/40 dark:bg-zinc-900/40 flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
               <div className="space-y-0.5">
                  <h3 className="text-base sm:text-lg font-black text-stone-900 dark:text-white tracking-tight">Stock List</h3>
                  <p className="text-[9px] sm:text-[10px] font-bold text-stone-400 dark:text-stone-500 uppercase tracking-widest opacity-80">Real-time inventory levels</p>
               </div>
               <div className="relative group max-w-sm w-full">
                  ...
                  <input 
                     ...
                     className="w-full h-10 sm:h-11 pl-11 pr-4 rounded-xl bg-surface dark:bg-zinc-800 border border-border text-[13px] font-medium text-stone-900 dark:text-white placeholder:text-stone-300 dark:placeholder:text-stone-700 shadow-sm focus:outline-none focus:ring-4 focus:ring-orange-500/5 transition-all"
                  />
               </div>
            </div>
               ...
               {products.length === 0 ? (
                  <div className="py-20 text-center space-y-4">
                     <div className="w-12 h-12 bg-surface dark:bg-zinc-800 rounded-2xl flex items-center justify-center mx-auto border border-border">
                        <Package className="h-6 w-6 text-stone-300 dark:text-stone-700" />
                     </div>
                     <p className="text-[12px] font-bold text-stone-400 dark:text-stone-500 uppercase tracking-widest">No inventory items found</p>
                  </div>
               ) : (
                 <table className="w-full text-left min-w-[750px] sm:min-w-0">
                  <thead>
                    <tr className="bg-surface/40 dark:bg-zinc-900/20 border-b border-border">
                      <th className="px-5 sm:px-8 py-4 sm:py-5 text-[9px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-500">Product</th>
                      <th className="px-5 sm:px-8 py-4 sm:py-5 text-right text-[9px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-500">Total Sales</th>
                      <th className="px-5 sm:px-8 py-4 sm:py-5 text-center text-[9px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-500">Status</th>
                      <th className="px-5 sm:px-8 py-4 sm:py-5 text-right text-[9px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-500">Stock Count</th>
                      ...
                      return (
                        <tr key={p.id as string} className="hover:bg-surface-secondary/60 dark:hover:bg-zinc-800/40 transition-all duration-300 group">
                          <td className="px-5 sm:px-8 py-5 sm:py-6 text-left">
                            <div className="flex items-center gap-3 sm:gap-4">
                              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-surface-secondary dark:bg-zinc-800 border border-border overflow-hidden shrink-0 shadow-sm">
                              ...
                              <div className="min-w-0">
                                ...
                                <p className="text-[9px] font-bold text-stone-400 dark:text-stone-500 uppercase tracking-widest mt-1 opacity-70">{p.product_type as string}</p>
                              </div>
                            </div>
                          </td>
                           <td className="px-5 sm:px-8 py-5 sm:py-6 text-right text-[12px] font-bold text-stone-400 dark:text-stone-500 tabular-nums">
                            ...
                            {isEditing ? (
                              <div className="flex justify-end">
                                 <input
                                   ...
                                   className="w-16 sm:w-20 h-8 sm:h-9 px-3 text-[13px] font-bold text-stone-900 dark:text-white text-right rounded-lg bg-surface dark:bg-zinc-800 border border-border outline-none focus:ring-2 focus:ring-orange-500/10 transition-all shadow-sm"
                                   min="0"
                                   autoFocus
                                 />
                              </div>
                          ...
                          <td className="px-5 sm:px-8 py-5 sm:py-6 text-right">
                            {isEditing ? (
                              <div className="flex gap-1.5 justify-end">
                                 <Button size="sm" className="h-8 sm:h-9 px-3 sm:px-4 rounded-lg bg-stone-900 dark:bg-white dark:bg-zinc-900 text-white dark:text-stone-900 dark:text-white font-bold text-[9px] sm:text-[10px] capitalize shadow-sm" loading={updating === p.id as string} onClick={() => updateInventory(p.id as string, editQty[p.id as string])}>
                                  Save
                                </Button>
