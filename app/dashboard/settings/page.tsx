                        ...
                        <div className="relative group w-32 h-32 mx-auto">
                           ...
                           <div className="relative w-full h-full rounded-none bg-surface dark:bg-surface border border-border shadow-none overflow-hidden flex flex-col items-center justify-center p-2">
                              {vendor.business_logo ? (
                                 ...
                                 <ImageIcon className="h-10 w-10 text-stone-300 dark:text-stone-700" />
                              )}
                              <div className="absolute inset-0 bg-stone-950/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center cursor-pointer">
                                 <CloudinaryUploadButton
                        ...
                        <section className="space-y-6 pt-8 border-t border-border">
                           ...
                           {vendor.affiliate_enabled && (
                              <div className="space-y-2 p-1 animate-in slide-in-from-top-1">
                                 <Label className="text-[10px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-600 ml-1">Base Commission (%)</Label>
                ...
                <GlassCard className="p-8 space-y-8 rounded-none border-border bg-surface/60 dark:bg-surface-secondary/40 shadow-none relative overflow-hidden">
                   ...
                   <div className="space-y-6">
                      {[
                         ...
                         <div key={i} className="flex items-center justify-between gap-6 pb-6 border-b border-border last:border-0 last:pb-0">
                            <div className="space-y-1">
                               <p className="text-sm font-bold text-stone-900 dark:text-white tracking-tight">{item.label}</p>
                               <p className="text-[11px] font-medium text-stone-400 dark:text-stone-600">{item.desc}</p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
