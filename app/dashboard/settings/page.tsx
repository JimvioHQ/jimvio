...
export default function SettingsPage() {
  ...
  const inputClass = "h-12 rounded-xl bg-surface dark:bg-surface-secondary/80 border border-border focus:ring-4 focus:ring-orange-500/5 focus:border-orange-500 text-stone-900 dark:text-white font-bold placeholder:text-stone-300 dark:placeholder:text-stone-600 transition-all text-sm px-4 sm:px-6 shadow-sm disabled:opacity-50";
  const selectClass = "h-12 w-full px-4 sm:px-6 rounded-xl border border-border bg-surface dark:bg-surface-secondary/80 text-stone-900 dark:text-white font-bold text-sm focus:outline-none focus:ring-4 focus:ring-orange-500/5 focus:border-orange-500 transition-all shadow-sm appearance-none cursor-pointer";
    ...
    >
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-10 px-4 sm:px-6 pt-6 sm:pt-12 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
           ...
           <div className="flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl bg-surface dark:bg-surface-secondary border border-border shadow-sm opacity-80 w-fit">
              <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-stone-400 dark:text-text-muted truncate max-w-[150px] sm:max-w-xs">{userEmail}</span>
           </div>
        </div>

        <Tabs defaultValue="profile" className="space-y-6 sm:space-y-8">
           <TabsList className="flex items-center gap-1 p-1 sm:p-1.5 rounded-xl bg-surface/60 dark:bg-surface-secondary/40 border border-border w-fit overflow-x-auto no-scrollbar max-sm:w-full">
               <TabsTrigger value="profile" className="px-4 sm:px-6 py-2 rounded-lg text-[9px] sm:text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-stone-900 dark:data-[state=active]:bg-white dark:bg-surface dark:data-[state=active]:text-stone-900 dark:text-white data-[state=active]:text-white shadow-none transition-all flex items-center gap-2">
                 <User className="h-3 w-3 sm:h-3.5 sm:w-3.5" /> Profile
               </TabsTrigger>
               {vendor && (
                 <TabsTrigger value="vendor" className="px-4 sm:px-6 py-2 rounded-lg text-[9px] sm:text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-stone-900 dark:data-[state=active]:bg-white dark:bg-surface dark:data-[state=active]:text-stone-900 dark:text-white data-[state=active]:text-white shadow-none transition-all flex items-center gap-2">
                   <Store className="h-3 w-3 sm:h-3.5 sm:w-3.5" /> Business
                 </TabsTrigger>
               )}
               <TabsTrigger value="notifications" className="px-4 sm:px-6 py-2 rounded-lg text-[9px] sm:text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-stone-900 dark:data-[state=active]:bg-white dark:bg-surface dark:data-[state=active]:text-stone-900 dark:text-white data-[state=active]:text-white shadow-none transition-all flex items-center gap-2">
                 <Bell className="h-3 w-3 sm:h-3.5 sm:w-3.5" /> Alerts
               </TabsTrigger>
               <TabsTrigger value="security" className="px-4 sm:px-6 py-2 rounded-lg text-[9px] sm:text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-stone-900 dark:data-[state=active]:bg-white dark:bg-surface dark:data-[state=active]:text-stone-900 dark:text-white data-[state=active]:text-white shadow-none transition-all flex items-center gap-2">
                   ...
                   <GlassCard className="p-6 sm:p-8 space-y-6 sm:space-y-8 rounded-2xl border-border bg-surface/60 dark:bg-surface-secondary/40 shadow-sm relative overflow-hidden">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                         <div className="space-y-1.5 sm:space-y-2">
                            <Label className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-stone-400 dark:text-text-muted ml-1">Full Name</Label>
                         ...
                         <div className="space-y-1.5 sm:space-y-2">
                            <Label className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-stone-400 dark:text-text-muted ml-1">Username</Label>
                            <div className="relative">
                               <div className="absolute left-4 sm:left-6 top-1/2 -translate-y-1/2 text-stone-300 dark:text-stone-700 font-bold text-sm">@</div>
                               <Input value={profile.username} onChange={e => setProfile(p => ({ ...p, username: e.target.value }))} className={cn(inputClass, "pl-10 sm:pl-12")} placeholder="username" />
                            </div>
                         </div>
                      </div>
                      ...
                      <div className="space-y-1.5 sm:space-y-2">
                         ...
                         <Textarea value={profile.bio} onChange={e => setProfile(p => ({ ...p, bio: e.target.value }))} placeholder="Tell us about yourself..." className="rounded-xl bg-surface dark:bg-surface/60 border-border focus:ring-4 focus:ring-orange-500/5 focus:border-orange-500 text-stone-900 dark:text-white font-bold text-sm px-4 sm:px-6 py-4 resize-none min-h-[100px] sm:min-h-[120px] shadow-sm shadow-stone-100/10 placeholder:text-stone-300 dark:placeholder:text-stone-700" />
                      </div>
                      ...
                      <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 pt-6 border-t border-border">
                         ...
                         <Button onClick={saveProfile} disabled={isPending} className="w-full md:w-auto h-11 sm:h-12 px-8 sm:px-10 rounded-xl bg-orange-500 text-white font-bold text-[9px] sm:text-[10px] uppercase tracking-widest shadow-[0_8px_20px_rgba(249,115,22,0.25)] hover:bg-orange-600 active:scale-95 transition-all border-none">
                  ...
                  <div className="lg:col-span-8">
                     <GlassCard className="p-6 sm:p-8 space-y-6 sm:space-y-8 rounded-2xl border-border bg-surface/60 dark:bg-surface-secondary/40 shadow-sm relative overflow-hidden">
                        <section className="space-y-4 sm:space-y-6">
                           ...
                           <div className="space-y-4 sm:space-y-6">
                              ...
                              <div className="space-y-1.5 sm:space-y-2">
                                 ...
                                 <Textarea value={vendor.business_description} onChange={e => setVendor(v => v ? ({ ...v, business_description: e.target.value }) : null)} className="rounded-xl bg-surface dark:bg-surface/60 border-border focus:ring-4 focus:ring-orange-500/5 focus:border-orange-500 text-stone-900 dark:text-white font-bold text-sm px-4 sm:px-6 py-4 resize-none min-h-[100px] placeholder:text-stone-300 dark:placeholder:text-stone-700 shadow-sm" />
                              </div>
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                 <div className="space-y-1.5 sm:space-y-2">
                           ...
                           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                              ...
                              <div className="space-y-1.5 sm:space-y-2">
                                 ...
                                 <div className="relative">
                                    ...
                                    <Input value={vendor.payout_account} onChange={e => setVendor(v => v ? ({ ...v, payout_account: e.target.value }) : null)} className={cn(inputClass, "pl-10 sm:pl-12 font-mono")} placeholder="Enter ID" />
                                 </div>
                              </div>
                           </div>
                        </section>
                        ...
                        <section className="space-y-4 sm:space-y-6 pt-6 sm:pt-8 border-t border-border">
                           ...
                           <div className="flex items-center justify-between p-4 sm:p-6 rounded-xl bg-surface dark:bg-surface/60 border border-border shadow-sm transition-all group">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 pt-6 border-t border-border">
                           ...
                           <Button onClick={saveVendor} disabled={isPending} className="w-full md:w-auto h-11 sm:h-12 px-8 sm:px-10 rounded-xl bg-orange-500 text-white font-bold text-[9px] sm:text-[10px] uppercase tracking-widest shadow-[0_8px_20px_rgba(249,115,22,0.25)] hover:bg-orange-600 active:scale-95 transition-all border-none">
                               {isPending ? <RefreshCw className="h-4 w-4 animate-spin mr-2" /> : <Save className="h-4 w-4 mr-2" />} 
                               Save Protocol
                           </Button>
                        </div>
             ...
             <div className="max-w-2xl">
                <GlassCard className="p-6 sm:p-8 space-y-6 sm:space-y-8 rounded-2xl border-border bg-surface/60 dark:bg-surface-secondary/40 shadow-sm relative overflow-hidden">
                   ...
                   <div className="space-y-4 sm:space-y-6">
                      ...
                      <Button className="h-11 sm:h-12 px-8 sm:px-10 rounded-xl bg-stone-900 dark:bg-white dark:bg-surface text-white dark:text-stone-900 dark:text-white font-bold text-[9px] sm:text-[10px] uppercase tracking-widest shadow-sm hover:bg-black dark:hover:bg-stone-200 active:scale-95 transition-all border-none w-full">
                         Update Password
                      </Button>
                   </div>
                   ...
                   <div className="p-5 sm:p-6 rounded-2xl bg-rose-500/10 border border-rose-500/20 space-y-3 mt-8 sm:mt-12">
                      ...
                      <Button variant="ghost" className="h-10 px-6 rounded-xl border border-rose-500/20 text-rose-500 font-bold text-[9px] sm:text-[10px] uppercase tracking-widest hover:bg-rose-500 hover:text-white transition-all w-full md:w-auto mt-2">
