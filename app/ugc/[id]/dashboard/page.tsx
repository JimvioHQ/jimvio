                              ...
                              <div className="flex items-center gap-5">
                                 ...
                                 <div className="flex-1 space-y-2 py-1">
                                    ...
                                    <div className="space-y-0.5">
                                       <a href={s.post_url} target="_blank" className="text-sm font-black text-zinc-900 dark:text-white hover:text-orange-500 transition-all flex items-center gap-1.5">
                                    ...
                                    <div className="flex items-center gap-4 pt-1">
                                       ...
                                       <div className="flex items-center gap-1.5">
                                          ...
                                          <span className="text-xs font-black text-zinc-900 dark:text-white">{formatMoney(Number(s.total_earnings) || 0, "USD")}</span>
